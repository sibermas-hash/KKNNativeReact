 ...
 */}
 ...
 <button onClick={() => openEditModal(a)} className="p-3 rounded-lg bg-white border border-slate-200 text-slate-400 hover:text-primary hover:border-primaryoutline-none" title="ATUR PENUGASAN">
 <ArrowUpRightIcon className="h-4 w-4 stroke-[2.5px]" />
 </button>
 {a.kelompok_count === 0 && (
 <button onClick={() => handleRemove(a.id)} className="p-3 rounded-lg bg-white border border-slate-200 text-slate-400 hover:text-rose-500 hover:border-rose-200outline-none" title="HENTIKAN PENUGASAN">
 ...
 <div className="p-4 bg-primary rounded-lg text-white relative z-10">
