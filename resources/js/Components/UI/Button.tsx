...
const variantStyles: Record<Variant, string> = {
    ...
    clean: 'border border-emerald-50/60 bg-white text-xs font-semibold text-emerald-950 hover:border-primary-400 hover:text-primary-600 shadow-sm transition-all active:scale-95'
};
