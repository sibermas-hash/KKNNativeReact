...
export const THEMES: Record<string, ThemeDefinition> = {
  ...
  midnight: {
    ...
    backdrop: 'linear-gradient(135deg, #020617 0%, #0f172a 55%, #111827 100%)',
    useGlassLayer: false,
    useParticles: false,
    vars: {
      '--profile-page': '#020617',
