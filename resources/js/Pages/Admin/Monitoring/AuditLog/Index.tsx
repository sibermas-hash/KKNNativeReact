      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 space-y-8 py-10 font-sans">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            ...
            icon={ShieldAlert}
            variant={stats.high_risk > 0 ? 'error' : 'info'}
          />
            ...
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black text-emerald-950/40 uppercase tracking-widest tabular-nums">
                  Transmission Stage {logs.meta.current_page} OF {logs.meta.last_page} &middot;{' '}
                  {stats.total} Logs Terdaftar
                </span>
              </div>
        ...
        >
          ...
          >
            {logs.data.map((log) => (
              ...
              >
                <PremiumTableCell>
                  <span className="text-[10px] font-black text-emerald-700/40 font-mono tracking-tighter uppercase group-hover:text-emerald-600 transition-colors">
                ...
                <PremiumTableCell>
                  <div className="flex items-center gap-4 py-1">
                    ...
                    <div className="flex flex-col gap-1">
                      <span className="text-[12px] font-bold text-emerald-950 leading-tight group-hover:text-emerald-700 transition-colors line-clamp-1">
                        {log.description}
                      </span>
                      <span
                        className={clsx(
                ...
                <PremiumTableCell align="right">
                  <div className="flex items-center justify-end gap-2">
                    <span className="text-[10px] font-black text-emerald-700/40 font-mono tabular-nums mr-2">
                      {log.created_at}
                    </span>
                    <Link
