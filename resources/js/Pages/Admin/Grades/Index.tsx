  ...
  return (
    <AppLayout title="Inisiasi Koreksi Nilai Manual">
      ...
      <div className="space-y-12 pb-24">
        ...
        */}
        <div className="relative overflow-hidden rounded-lg bg-white from-rose-900 p-10 md:p-14 border border-slate-200 flex flex-col lg:flex-row lg:items-center justify-between gap-6 group">
