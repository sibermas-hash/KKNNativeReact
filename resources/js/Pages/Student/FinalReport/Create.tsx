      ...
      <AppLayout title="Laporan Akhir">
        ...
        <div className="mx-auto max-w-4xl py-20 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-bold text-emerald-950 font-bold text-center">
              Akses Terbatas
            </h2>
      ...
      <div className="mx-auto max-w-5xl space-y-10 pb-24">
          ...
          <div className="relative z-10 space-y-3">
            <div className="flex items-center gap-4 text-emerald-600 mb-2">
              ...
              <span className="text-sm font-bold uppercase tracking-wider text-xs font-semibold opacity-60">
                Terminal Penutup KKN
              </span>
            </div>
            <h1 className="text-3xl font-extrabold text-emerald-950 tracking-tight uppercase leading-none">
              Final Report & Luaran
            </h1>
            <p className="text-sm font-medium text-emerald-950">
              Puncak dari perjalanan pengabdian unit{' '}
              <span className="text-emerald-600 font-bold">{group.name}</span>.
            </p>
          </div>
          ...
          {existingReport && (
            <div className="relative z-10 flex items-center gap-6 bg-emerald-50/30 px-8 py-6 rounded-xl border border-emerald-50/60">
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold text-emerald-950 truncate max-w-[150px] tracking-tight">
        ...
        {!isReportLocked ? (
            ...
            <div className="rounded-[2.5rem] border border-emerald-50/60 bg-white p-10 lg:p-12 shadow-sm space-y-8">
              <div className="flex items-center gap-4 border-b border-slate-50 pb-6">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-emerald-950 font-semibold uppercase text-xs mt-2 leading-none">
                    Informasi inti dan abstraksi kegiatan
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-[2.5rem] border border-emerald-50/60 bg-white p-10 lg:p-12 shadow-sm space-y-8">
              <div className="flex items-center gap-4 border-b border-slate-50 pb-6">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-emerald-950 font-semibold uppercase text-xs mt-2 leading-none">
                    Link jejak digital pengabdian masyarakat
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-[2.5rem] border border-emerald-50/60 bg-white p-10 lg:p-12 shadow-sm space-y-10">
              <div className="flex items-center gap-4 border-b border-slate-50 pb-6">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-emerald-950 font-semibold uppercase text-xs mt-2 leading-none">
                    Berkas ilmiah, poster peta, dan laporan utama
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    <FileInput
                      ...
                      accept=".pdf,.doc,.docx"
                      onChange={(f) => form.setData('article_1', f)}
                    />
                    <FileInput
                      label="Artikel Ilmiah 2"
                      icon={<FileText size={18} />}
                      accept=".pdf,.doc,.docx"
                      onChange={(f) => form.setData('article_2', f)}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid gap-6 md:grid-cols-3">
                    <FileInput
                      ...
                      onChange={(f) => form.setData('poster_1', f)}
                    />
                    <FileInput
                      label="Poster II"
                      icon={<Map size={18} />}
                      accept=".jpg,.jpeg,.png,.pdf"
                      onChange={(f) => form.setData('poster_2', f)}
                    />
                    <FileInput
                      label="Poster III"
                      icon={<Map size={18} />}
                      accept=".jpg,.jpeg,.png,.pdf"
                      onChange={(f) => form.setData('poster_3', f)}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-6 pt-6 border-t border-slate-50">
                  ...
                  <div className="relative group/main">
                    ...
                    <div className="bg-rose-50/30 border-2 border-dashed border-rose-100 rounded-xl p-12 text-center group-hover/main:bg-rose-50 transition-all">
                      ...
                      <p className="text-sm font-bold text-emerald-950 font-semibold uppercase text-xs mt-2 leading-none">
                        Sesuai Format Baku LPPM UIN SAIZU
                      </p>
                    </div>
                  </div>
                  {form.errors.file && (
          ...
          <section className="rounded-[2.5rem] border border-emerald-100 bg-emerald-50/30 p-12 lg:p-16 text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-emerald-950 font-bold text-center uppercase tracking-tight">
              ...
              <p className="text-xs font-bold text-emerald-950 uppercase tracking-wider text-xs font-semibold leading-relaxed max-w-md mx-auto">
                ...
                <span className="text-emerald-600 font-bold">{group.name}</span> sudah berhasil
                diunggah oleh anggota: <br />
                <span className="text-lg text-emerald-950 lowercase mt-2 block font-extrabold">
                  {uploadedBy || 'Rekan Kelompok'}
                </span>
              </p>
              <p className="text-xs text-emerald-700 mt-4 italic">
                Sesuai kebijakan LPPM, pengunggahan laporan akhir cukup dilakukan oleh satu
                perwakilan kelompok.
              </p>
            </div>
            <div className="pt-8">
    ...
    <div className="relative group/file">
      ...
      <div className="bg-emerald-50/30 border border-emerald-50/60 rounded-2xl p-5 flex items-center gap-4 group-hover/file:bg-white group-hover/file:border-emerald-200 transition-all">
        ...
        <div className="overflow-hidden">
          <p className="text-sm font-bold text-emerald-950 font-semibold uppercase text-xs leading-none mb-1.5">
            {label}
          </p>
