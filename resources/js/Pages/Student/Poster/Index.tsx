            ...
            <div className="mx-auto max-w-4xl space-y-6">
                ...
                <div className="rounded-lg border border-slate-200 bg-white p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-xl font-semibold text-slate-900">Poster Peta Potensi Desa</h1>
                    ...
                    <div className="mt-4 rounded-lg border border-slate-100 bg-slate-50 p-4 text-sm text-slate-600">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="font-medium text-slate-900">Poster Peta Potensi Desa sesuai Lampiran 10 Panduan KKN</p>
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-2 text-sm text-slate-500">Pastikan poster yang Anda buat memuat elemen-elemen berikut:</p>
                ...
                {kelompok.poster_potensi_desa_path && (
                    <div className="rounded-lg border border-slate-200 bg-white p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h2 className="font-semibold text-slate-900">Poster Saat Ini</h2>
                                <p className="text-sm text-slate-500">{kelompok.poster_potensi_desa_name}</p>
                            </div>
                        </div>
                        ...
                        {isImage(kelompok.poster_potensi_desa_name || '') ? (
                            ...
                            <div className="flex items-center gap-4 rounded-lg border border-slate-200 bg-slate-50 p-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-sm font-medium text-slate-900 truncate">{kelompok.poster_potensi_desa_name}</p>
                ...
                <form onSubmit={handleSubmit} className="rounded-lg border border-slate-200 bg-white p-6">
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="font-semibold text-slate-900">Unggah Poster Baru</h2>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/upload">
                                <input
                                    ...
                                    className="block w-full text-sm text-slate-700 file:mr-4 file:rounded-lg file:border-0 file:bg-emerald-50 file:px-4 file:py-2.5 file:text-sm file:font-semibold file:text-emerald-700 hover:file:bg-emerald-100 file:cursor-pointer"
                                />
                            </div>
                            {form.errors.poster && (
                                ...
                                <div className="flex items-center gap-4">
                                    {form.data.poster.type.startsWith('image/') ? (
                                        <>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm font-medium text-slate-900 truncate">{form.data.poster.name}</p>
                        ...
                        <div className="rounded-lg border border-slate-100 bg-slate-50 p-4 text-xs text-slate-500 space-y-1">
                            <p className="font-medium text-slate-700">Ketentuan:</p>
