    ...
    <AppLayout title={`Unit Detail: ${group.code || ''}`}>
      ...
      >
        ...
        >
          <div className="space-y-6">
            <div className="flex items-center gap-6">
              <Link
                ...
                className="h-14 w-14 bg-white border border-slate-100 rounded-2xl flex items-center justify-center text-gray-400 hover:text-emerald-600 hover:border-emerald-200 transition-all shadow-sm group/back"
              >
                <ArrowLeft
                  size={24}
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-4 text-emerald-600">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.4em] leading-none">
                    Operation Center / Unit Insight
                  </span>
                </div>
                <h1 className="text-5xl lg:text-7xl font-black text-gray-900 tracking-tighter uppercase leading-[0.8] flex flex-col pt-2">
            ...
            <p className="text-lg font-bold text-gray-400 tracking-tight leading-relaxed max-w-2xl uppercase italic opacity-80">
              ...
              <span className="text-gray-900 not-italic">
                Diagnosis menyeluruh terhadap kluster unit, pembina taktis, inventarisasi anggota,
                dan manifest program kerja.
              </span>
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 shrink-0">
            <div className="h-24 px-10 rounded-[2.5rem] bg-slate-50 border border-slate-100 flex flex-col justify-center gap-1 shadow-sm group">
              ...
              <p className="text-xl font-black text-gray-900 tracking-wider font-mono group-hover:text-emerald-600 transition-colors uppercase leading-none">
                {group.token || 'UNGENERATED'}
              </p>
            </div>
            <div className="h-24 px-10 rounded-[2.5rem] bg-emerald-600 text-white flex items-center justify-center gap-6 shadow-2xl relative overflow-hidden">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(16,185,129,0.1),transparent)]" />
              <div className="flex flex-col gap-1 relative z-10">
                <span className="text-[9px] font-bold text-emerald-500 uppercase tracking-[0.3em] leading-none italic">
                  Operational Status
                </span>
        ...
        >
          <MetricCard
            label="Active Period"
            value={group.periode?.name || 'N/A'}
            icon={Briefcase}
            color="slate"
          />
          <MetricCard
            label="Lead Director"
            value={mainLecturer?.nama?.split(' ')[0] || 'UNSET'}
            icon={UserCheck}
            color="emerald"
          />
          <MetricCard
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-12 items-start">
          <div className="xl:col-span-8 space-y-12">
            ...
            >
              <div className="px-10 py-10 bg-emerald-700 flex flex-col md:flex-row md:items-center justify-between gap-8">
                <div className="flex items-center gap-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  <thead className="bg-slate-50 border-b border-slate-100">
                    <tr>
                      <th className="px-10 py-8 text-[10px] font-black uppercase tracking-[0.4em] text-gray-400">
                        Identify / NIM
                      </th>
                      <th className="px-10 py-8 text-[10px] font-black uppercase tracking-[0.4em] text-gray-400">
                        Department Vector
                      ...
                      <th className="px-10 py-8 text-[10px] font-black uppercase tracking-[0.4em] text-gray-400 text-right">
                        Operations
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-50">
                    {memberRows.length > 0 ? (
                        ...
                        <tr key={m.id} className="group hover:bg-emerald-50/20 transition-all">
                          <td className="px-10 py-8">
                            <div className="flex flex-col gap-1.5">
                              <span className="text-base font-black text-gray-900 tracking-tight leading-none group-hover:text-emerald-700 transition-colors uppercase italic">
                                {m.mahasiswa?.nama || '-'}
                              </span>
                              <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest font-mono italic">
                                {m.mahasiswa?.nim || '-'}
                              </span>
                            </div>
                          </td>
                          <td className="px-10 py-8">
                            <div className="flex flex-col gap-1.5">
                              <span className="text-[10px] font-black text-gray-700 uppercase tracking-tight leading-none">
                          ...
                          <td className="px-10 py-8">
                            <div
                              className={clsx(
                                ...
                                m.role === 'Ketua'
                                  ? 'bg-bg-emerald-50 text-emerald-500 shadow-xl shadow-emerald-500/10'
                          ...
                          <td className="px-10 py-8 text-right">
                            <div className="flex justify-end gap-3 opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0 transition-all">
                              <Link
                                ...
                                className="h-12 px-6 bg-white border border-slate-100 text-gray-400 hover:text-emerald-600 hover:border-emerald-200 rounded-2xl flex items-center justify-center text-[9px] font-black uppercase tracking-widest shadow-sm active:scale-95 transition-all"
                                title="Inspect"
                              >
                                Inspect
                              </Link>
                      ...
                      <tr>
                        <td
                          colSpan={5}
                          className="px-10 py-24 text-center text-[10px] font-black text-slate-200 uppercase tracking-[0.4em] italic opacity-50"
                        >
                          Personnel Database Offline
                        </td>
                      </tr>
                    )}
                  </tbody>
            ...
            >
              <div className="px-10 py-10 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="h-12 w-12 bg-white border border-slate-200 rounded-2xl flex items-center justify-center text-sm font-black text-gray-900">
                    {workPrograms.length}
                  </div>
                </div>
              </div>
              <div className="p-10 space-y-4">
                {workPrograms.length > 0 ? (
                  workPrograms.map((p) => (
                    <div
                      key={p.id}
                      className="group/pro relative flex items-center justify-between p-8 bg-white border border-slate-100 rounded-3xl hover:border-emerald-500 hover:shadow-2xl hover:shadow-emerald-50 transition-all overflow-hidden"
                    >
                      <div className="flex items-center gap-8 relative z-10">
                        <div className="w-14 h-14 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-300 group-hover/pro:bg-emerald-600 group-hover/pro:text-white transition-all">
                          <Zap size={24} strokeWidth={2.5} />
                        </div>
                        <div className="flex flex-col gap-1">
                          <span className="text-base font-black text-gray-900 uppercase tracking-tighter group-hover/pro:text-emerald-700 transition-colors italic">
                            {p.title || 'Untitled Manifest'}
                          </span>
                          <div className="flex items-center gap-3">
                            <span className="text-[9px] font-black text-slate-300 uppercase tracking-[0.2em] italic">
                              Protocol ID: #{p.id.toString().padStart(4, '0')}
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="py-24 text-center border-4 border-dashed border-slate-50 rounded-[2.5rem] bg-slate-50/10 flex flex-col items-center gap-6">
                    ...
                    <div className="space-y-1">
                      <p className="text-sm font-black text-slate-300 uppercase tracking-widest leading-none">
                        No Manifests Detected
                      </p>
                      <p className="text-[10px] font-bold text-slate-200 uppercase tracking-widest italic">
                        Kluster ini belum menginisiasi program kerja.
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div className="xl:col-span-4 space-y-12">
            ...
            <motion.section
              variants={itemVariants}
              className="bg-emerald-600 rounded-[3.5rem] p-10 text-white space-y-10 relative overflow-hidden group/l shadow-2xl shadow-emerald-200"
            >
              ...
              <div className="space-y-6 relative z-10">
                {lecturerRows.length > 0 ? (
                  lecturerRows.map((l) => (
                    <div
                      key={l.id}
                      className="p-8 bg-white/5 border border-white/10 rounded-[2.5rem] group/card hover:bg-white hover:text-gray-950 transition-all flex flex-col gap-4 shadow-sm"
                    >
                      <div className="space-y-1">
                        <p className="text-lg font-black uppercase tracking-tighter italic leading-none">
                          {l.nama || '-'}
                        </p>
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest font-mono group-hover/card:text-emerald-600 transition-colors leading-none pt-1">
                          NIP: {l.nip || '-'}
                        </p>
                      </div>
                      <div className="flex items-center justify-between">
                        <div className="px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 text-[9px] font-black uppercase tracking-widest group-hover/card:bg-emerald-600 group-hover/card:text-white transition-all">
                          Role: {l.pivot?.role || 'ANGGOTA'}
                        </div>
                        <ShieldCheck
                          size={24}
                          className="text-emerald-500 opacity-20 group-hover/card:opacity-100 transition-opacity"
                        />
                      </div>
                    </div>
                  ))
                  ...
                  <p className="text-sm font-bold text-gray-500 italic uppercase">
                    NO LECTURER ASSIGNED TO MODULE.
                  </p>
                )}
              </div>
            </motion.section>
            ...
            <motion.section
              variants={itemVariants}
              className="bg-white border border-slate-100 rounded-[3.5rem] p-10 space-y-10 shadow-2xl shadow-slate-200/50 group/geo relative overflow-hidden"
            >
              <div className="flex items-center gap-5">
                <div className="h-12 w-12 bg-slate-50 rounded-2xl flex items-center justify-center text-rose-500 group-hover/geo:bg-emerald-600 group-hover/geo:text-white transition-all">
              ...
              <div className="space-y-8">
                <div className="space-y-3">
                  <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none italic ml-1">
                    Deployment Zone
                  </p>
                  <div className="p-8 bg-slate-50 border border-slate-100 rounded-[2rem] group/loc hover:border-emerald-500 transition-all">
                    <p className="text-lg font-black text-gray-900 uppercase tracking-tight italic group-hover/loc:text-emerald-700 transition-colors leading-tight mb-2">
                ...
                {group.posko ? (
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex flex-col justify-end p-8">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-black text-white uppercase tracking-widest">
                              Post Infrastructure Image
                            </span>
                          </div>
                        </div>
                      </div>
                    )}
                    <div className="p-8 bg-emerald-700 rounded-[2.5rem] text-white space-y-6 shadow-2xl shadow-emerald-200">
                      <div className="grid grid-cols-2 gap-6 opacity-60">
                        <div className="space-y-1">
                          ...
                          <p className="text-xs font-black font-mono uppercase">
                      ...
                      {group.posko.gmaps_link ? (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="w-full h-16 bg-emerald-600 hover:bg-white hover:text-gray-900 rounded-2xl flex items-center justify-center gap-4 text-[10px] font-black uppercase tracking-[0.3em] transition-all shadow-xl active:scale-95"
                        >
                          <Globe size={18} strokeWidth={3} />
                          Launch External Map
                        </a>
                      ) : (
                        <div className="text-[9px] font-black text-gray-500 uppercase tracking-widest flex items-center gap-3 italic">
                  ...
                  <div className="py-20 text-center bg-slate-50 border-4 border-dashed border-white rounded-[2.5rem] flex flex-col items-center gap-4 group/none hover:border-emerald-100 transition-all">
                    <Search
                      size={40}
                      className="text-slate-100 group-hover/none:text-emerald-100 transition-colors"
                    />
                    <p className="text-[10px] font-black text-slate-200 uppercase tracking-[0.4em] group-hover/none:text-emerald-500 transition-colors italic">
                      Infrasignal Lost
                    </p>
                  </div>
                )}
        ...
        <motion.div
          variants={itemVariants}
          className="bg-emerald-600 rounded-[3.5rem] p-16 flex flex-col lg:flex-row items-center justify-between gap-12 text-white relative overflow-hidden group/footer shadow-2xl"
        >
          ...
          <div className="flex items-center gap-10 relative z-10">
            ...
            <div className="space-y-3">
              <h4 className="text-3xl font-black uppercase tracking-tighter leading-none italic">
                Authorized Insight Manifest
              </h4>
          ...
          <div className="flex items-center gap-6 relative z-10">
            <div className="text-right hidden lg:block">
              <p className="text-[10px] font-black uppercase tracking-widest leading-none mb-1 opacity-50 italic">
                System Uptime
              </p>
            ...
            <div className="h-20 w-20 rounded-[1.5rem] bg-emerald-600 flex items-center justify-center shadow-2xl group-hover/footer:scale-110 transition-transform">
