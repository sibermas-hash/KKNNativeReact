...
export default function ImportPreview({ preview, group, dplWeights }: Props) {
 ...
 <h1 className="text-2xl font-semibold text-emerald-950">Pratinjau Impor Evaluasi</h1>
 ...
 className="rounded-lg border border-emerald-50/60 px-4 py-3 text-sm font-semibold text-emerald-800 hover:bg-emerald-50/30"
 >
 Kembali
 </button>
 <button
 ...
 <tr>
 <th className="px-6 py-3 text-left text-xs font-semibold text-emerald-950">Mahasiswa</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-emerald-950">Laporan Akhir</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-emerald-950">Pelaksanaan</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-emerald-950">Artikel</th>
 ...
 <p className="text-xs text-emerald-950">{item.nim}</p>
 </td>
 <td className="px-6 py-4 text-sm text-emerald-950">{item.final_report_score}</td>
 <td className="px-6 py-4 text-sm text-emerald-950">{item.execution_score}</td>
 <td className="px-6 py-4 text-sm text-emerald-950">{item.article_score}</td>
 <td className="px-6 py-4">
 <span
