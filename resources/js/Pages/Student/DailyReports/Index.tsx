            ...
            <div className="space-y-12 pb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white border border-slate-200rounded-lg p-8 flex items-center gap-6 group overflow-hidden relative">
                        <div className="absolute top-0 right-0 p-4 text-primary group-hover:scale-125">
                ...
                <div className="space-y-8">
                    {reportList.length === 0 ? (
                        <div className="bg-white rounded-lg border border-slate-200 p-32 text-center group overflow-hidden relative">
                             <div className="absolute top-0 left-0 w-full h-full text-slate-900 pointer-events-none group-hover:scale-105 transition-transform[2000ms]">
                        ...
                        reportList.map((r) => (
                            <div 
                                key={r.id} 
                                className="group bg-white rounded-lg border border-slate-200 p-10hover:shadow-2xl hover:border-primary relative overflow-hidden flex flex-col md:flex-row md:items-center gap-6"
                            >
                                <div className="absolute top-0 right-0 p-12 text-slate-900 pointer-events-none group-hover:rotate-6 group-hover:scale-110 transition-transform">
                                ...
                                <div className="flex items-center justify-between md:flex-col md:items-end md:justify-center gap-6 relative z-10 shrink-0 border-t border-slate-200 md:border-t-0 pt-8 md:pt-0">
                                    ...
                                    {r.status === 'revision' ? (
                                        <Link 
                                            ...
                                            className="h-12 px-6 bg-rose-600 text-white rounded-xl text-xs font-semibold  hover:bg-rose-700active:scale-95 flex items-center gap-2"
                                        >
