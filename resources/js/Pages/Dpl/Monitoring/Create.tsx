        ...
        <AppLayout title="Tambah Monitoring">
            ...
            <div className="space-y-8">
                ...
                <section className="rounded-lg border border-slate-200 bg-white p-8">
                    <h1 className="text-2xl font-semibold text-slate-900 mb-2">Form Laporan Monitoring</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label htmlFor="kelompok_id" className="block text-sm font-medium text-slate-700 mb-1">
                        ...
                        <div>
                            <label htmlFor="tanggal_kunjungan" className="block text-sm font-medium text-slate-700 mb-1">
                        ...
                        <div>
                            <label htmlFor="permasalahan" className="block text-sm font-medium text-slate-700 mb-1">
                        ...
                        <div>
                            <label htmlFor="solusi" className="block text-sm font-medium text-slate-700 mb-1">
                        ...
                        <div>
                            <label htmlFor="catatan_tambahan" className="block text-sm font-medium text-slate-700 mb-1">
                                Catatan Tambahan
                            </label>
                            <textarea
                                id="catatan_tambahan"
