            ...
            <div className="space-y-12 pb-24">
                ...
                {evaluations.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {evaluations.map((ev) => (
                            <div key={ev.id} className="group bg-white rounded-lg border border-slate-200 overflow-hiddenhover:shadow-2xl hover:border-primary relative">
                                <div className="absolute top-0 right-0 p-10 text-slate-900 pointer-events-none group-hover:rotate-12 group-hover:scale-110 transition-transform">
