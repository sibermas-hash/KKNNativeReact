            ...
            <div className="max-w-[1600px] mx-auto space-y-8 pb-20 font-sans">
                ...
                <div className="bg-white rounded-[2.5rem] border border-emerald-50/60 shadow-sm p-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative overflow-hidden">
                    ...
                    <div className="relative space-y-3">
                        ...
                        <h1 className="text-2xl font-[900] text-emerald-950 tracking-tight">Logbook Mahasiswa</h1>
                                    ...
                                    <tr key={report.id} className="hover:bg-emerald-50/30/80 transition-all group">
                                        <td className="px-6 py-6">
                                            <div className="flex items-center gap-4">
                                                <div className="h-12 w-12 rounded-2xl bg-white border border-emerald-50/60 shadow-sm flex flex-col items-center justify-center shrink-0">
                                                    ...
                                                    <p className="text-sm font-bold text-emerald-950 leading-none">{report.date.split(' ')[0]}</p>
                                                </div>
                                                <div className="space-y-1">
                                                    <p className="text-sm font-extrabold text-emerald-950 line-clamp-1">{report.title}</p>
                                        ...
                                        <td className="px-6 py-6">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="text-sm font-bold text-emerald-950">{report.student.name}</p>
                                            ...
                                            {report.ai_analysis ? (
                                                <div className="flex flex-col items-center gap-1 group/ai cursor-help relative">
                                                    <div className={clsx(
                                                        ...
                                                        report.ai_analysis.abcd_compliance >= 8 ? "bg-emerald-50 border-emerald-50 text-emerald-600" :
                    ...
                    {reports.total > 15 && (
                        <div className="px-6 py-8 border-t border-emerald-50/60 flex items-center justify-between bg-emerald-50/30/10">
                            <p className="text-xs font-bold text-emerald-950 font-semibold uppercase text-xs">
                                Menampilkan <span className="text-emerald-950 font-bold">{reports.data.length}</span> dari <span className="text-emerald-950 font-bold">{reports.total}</span> Laporan
                            </p>
                                ...
                                {reports.links.map((link, i) => (
                                    <Link
                                        ...
                                        className={clsx(
                                            ...
                                            link.active ? "bg-emerald-900 text-white shadow-lg" : "bg-white border border-emerald-50/60 text-emerald-950 hover:border-emerald-200 hover:text-emerald-600"
                                        )}
                                    />
                                ))}
                            </div>
