                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-200 pb-8">
                    <div className="flex items-center gap-6">
                        <Link 
                            ...
                            className="h-14 w-14 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-slate-300 hover:text-primary hover:border-primary hover:shadow-xl"
                        >
                            ...
                            {hasCoordinates ? (
                                <div className="space-y-8 relative z-10">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="w-full flex items-center justify-center gap-4 py-5 bg-primary text-white rounded-lg text-xs font-semibold  hover:bg-primary-darkactive:scale-95"
                                    >
                            ...
                            <section className="bg-white rounded-lg border border-slate-200 p-10">
                                ...
                                <div className="space-y-5">
                                    <button 
                                        ...
                                        className="w-full flex items-center justify-center gap-4 py-5 bg-emerald-500 text-white rounded-lg text-xs font-semibold  hover:bg-emerald-600active:scale-95"
                                    >
