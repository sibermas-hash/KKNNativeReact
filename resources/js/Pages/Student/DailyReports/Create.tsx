                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-slate-200 p-12 space-y-6 relative overflow-hidden group">
                            ...
                            <div className="flex pt-8 relative z-10 border-t border-slate-200">
                                <button 
                                    ...
                                    className="h-20 px-16 bg-slate-900 text-whiterounded-lg text-xs font-semibold  hover:bg-blackactive:scale-95 disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center gap-5 group group/submit"
                                >
                                    <UploadCloud className={clsx("w-6 h-6 text-primary", form.processing ? "animate-bounce" : "group-hover/submit:translate-y-[-3px]")} />
                    ...
                    <aside className="space-y-12">
                            ...
                            <div className="space-y-8">
                                <div className="relative group/dropzone">
                                    <div className="group relative flex flex-col items-center justify-center p-10 border-2 border-dashed border-slate-200 rounded-lg bg-slate-50 hover:bg-white hover:border-primarycursor-pointer">
                                        ...
                                        />
                                        <div className="flex flex-col items-center text-center relative z-10 group-hover/dropzone:scale-105 transition-transform">
                        ...
                        <section className="p-10 bg-slate-950 rounded-lg text-white relative overflow-hidden border border-slate-900">
                             <div className="absolute top-0 right-0 p-8 text-primary pointer-events-none group-hover:scale-110 transition-transform">
