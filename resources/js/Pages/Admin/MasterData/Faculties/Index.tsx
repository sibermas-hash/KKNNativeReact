              ...
              <div className="space-y-6">
                ...
                <div className="p-4 bg-amber-50 rounded-xl border border-amber-100 flex gap-3">
                  ...
                  <p className="text-[10px] font-bold text-amber-800 leading-relaxed uppercase tracking-tight">
                    Data fakultas dikelola secara terpusat melalui sinkronisasi master mahasiswa.
                    Perubahan manual dinonaktifkan untuk menjaga integritas relasi data.
                  </p>
                </div>
              ...
              >
                {faculties.data.map((faculty) => (
                  <PremiumTableRow key={faculty.id} className="group">
                    ...
                    <PremiumTableCell>
                      <div className="flex flex-col">
                        <span className="text-sm font-bold text-emerald-950 leading-none group-hover:text-emerald-700 transition-colors">
                          {faculty.name}
                        </span>
                    ...
                    <PremiumTableCell>
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] font-bold text-emerald-600/60 uppercase tracking-tighter mt-0.5">
                          Terintegrasi Master
                        </span>
                      </div>
                    </PremiumTableCell>
