 ...
 */}
 ...
 className="flex-1 py-4 bg-white border border-slate-200 text-xs font-semibold text-slate-400 rounded-lg hover:text-primary hover:border-primary"
 >
 ...
 className="flex-1 py-4 bg-primary text-white text-xs font-semibold rounded-lg hover:bg-primary-darkdisabled:opacity-50 disabled:"
 >
 INPUT PRESENSI
 </button>
 <button
 ...
 className="flex-1 py-4 bg-white border border-slate-200 text-xs font-semibold text-slate-400 rounded-lg hover:text-primary hover:border-primarydisabled:opacity-50 disabled:"
 >
 UBAH DATA
 </button>
 <button
 ...
 className="flex-1 py-4 bg-rose-50 border border-rose-100 text-xs font-semibold text-rose-500 rounded-lg hover:bg-rose-100disabled:opacity-50 disabled:"
 >
 BATALKAN KEGIATAN
 </button>
 </div>
 ...
 <div className="col-span-full py-40 bg-white rounded-lg border-2 border-dashed border-slate-200 flex flex-col items-center justify-center gap-6 group">
