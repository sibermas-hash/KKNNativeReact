...
export default function StudentWorkProgramCreate() {
  ...
  return (
    <AppLayout title="Ajukan Program Kerja">
      <Head title="Ajukan Proker | SIBERMAS" />
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          <div className="rounded-[2.5rem] border border-emerald-50/60 bg-white p-10 lg:p-12 shadow-sm space-y-8">
            <div className="flex items-center gap-4 border-b border-slate-50 pb-6 mb-4">
              ...
              <div>
                <h2 className="text-lg font-bold text-emerald-950 font-bold text-center leading-none">
                  Klasifikasi & Inti
                </h2>
            ...
            <FormTextarea
              ...
              className="rounded-2xl bg-emerald-50/30/50 border-emerald-50/60 focus:bg-white py-4 font-medium min-h-[120px]"
            />
          </div>
