...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('kegiatan_kkn', function (Blueprint $table) {
            ...
            if (! Schema::hasColumn('kegiatan_kkn', 'location_source')) {
    ...
    public function down(): void
    {
        ...
        Schema::table('kegiatan_kkn', function (Blueprint $table) {
            $columns = array_values(array_filter([
                Schema::hasColumn('kegiatan_kkn', 'gps_accuracy') ? 'gps_accuracy' : null,
                Schema::hasColumn('kegiatan_kkn', 'captured_at') ? 'captured_at' : null,
                Schema::hasColumn('kegiatan_kkn', 'location_source') ? 'location_source' : null,
            ]));
