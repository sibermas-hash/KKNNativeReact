                ...
                <div className="relative overflow-hidden rounded-lg bg-white from-primary-DEFAULT via-primary-dark to-[#043d23] p-10 md:p-14 border border-primary flex flex-col lg:flex-row lg:items-center justify-between gap-6 group">
                    ...
                    <div className="relative z-10 space-y-5 flex-1">
                        ...
                        <h1 className="text-4xl md:text-5xl font-semibold text-white  ">
                            Algoritma <span className="text-emerald-300 text-glow-emerald">Assessment</span>
                        </h1>
                    ...
                    <div className="flex flex-wrap items-center gap-5 shrink-0 relative z-10">
                        <div
                            className={clsx(
                                'bg-white/10 p-6 rounded-lg border flex items-center gap-6 min-w-[240px] group/stat',
                                invalidSections.length === 0 ? 'border-slate-200' : 'border-rose-400/30 bg-rose-500/10',
                            )}
                        >
                            <div className={clsx(
                                "p-3 rounded-lg",
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                        <div className="xl:col-span-2 space-y-8">
                            {sectionsWithTotals.map((section) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="absolute top-0 right-0 p-10 text-slate-900 pointer-events-none group-hover:rotate-12 transition-transform">
                                        ...
                                        <div className="relative z-10 space-y-8">
                                            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 border-b border-slate-200 pb-8">
                                                <div className="flex items-center gap-4">
                                                    <div className="p-3 bg-primary/10 rounded-xl text-primary border border-primary
                                                ...
                                                >
                                                    <div className="text-[10px] text-sm  text-slate-400">
                                                    ...
                                                    return (
                                                        <div key={item.id} className="space-y-3">
                                                            <label
                                                                ...
                                                                className="text-[11px] text-sm text-slate-500  ml-1 block"
                                                            >
                                                                {item.label}
                                                            </label>
                                                            <input
                                                                ...
                                                                className="w-full bg-slate-50 border border-slate-200 text-slate-900 text-lg font-extrabold h-16 rounded-lg px-6 focus:bg-white focus:border-primary/50 outline-none"
                                                            />
                                            ...
                                            {!isValid && (
                                                <div className="p-6 bg-rose-50 border border-rose-100 rounded-lg flex items-center gap-4">
                                                    ...
                                                    <p className="text-[10px] text-sm text-rose-600  leading-normal">
                        ...
                        <div className="space-y-8">
                            <div className="bg-slate-50 p-10 rounded-lg border border-slate-200 relative overflow-hidden group">
                                <div className="absolute -top-10 -right-10 p-10 text-primary group-hover:scale-110 transition-transform">
                            ...
                            <div className="p-8 bg-whiterounded-lg border border-slate-200 relative overflow-hidden flex flex-col gap-6">
                                ...
                                <p className="text-[10px] text-slate-400 font-medium  leading-normal border-l-2 border-primary/30 pl-4">
                                    Perubahan bobot akan langsung memengaruhi perhitungan nilai yang belum difinalisasi.
                                </p>

                                {recentlySuccessful && (
                                    <div className="p-4 rounded-lg bg-emerald-50 border border-emerald-100 text-emerald-700 text-xs text-sm 
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center justify-center gap-3 px-6 py-4 bg-primary text-white rounded-xl font-extrabold text-xs  hover:bg-primary-darkactive:scale-95 disabled:opacity-30 disabled:grayscale"
                                >
...
function InfoRow({ title, value }: { title: string; value: string }) {
    return (
        <div className="flex items-start justify-between gap-4 border-b border-slate-200/70 pb-4">
            <div>
                <div className="text-[10px] text-sm  text-slate-400">{title}</div>
