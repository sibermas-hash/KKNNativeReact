...
class IndexedDBService {
     ...
     * Save data to store
     */
    async save<T extends keyof StorageSchema>(storeName: T, data: StorageSchema[T]): Promise<IDBValidKey> {
     ...
     * Get record by key
     */
    async get<T extends keyof StorageSchema>(storeName: T, key: any): Promise<StorageSchema[T] | undefined> {
        const db = await this.init();
