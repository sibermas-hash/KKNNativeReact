...
export default function AdminFinalReportShow({ report }: Props) {
 ...
 className="inline-flex items-center gap-2 text-sm text-white hover:text-[#1a7a4a] transition-colors font-semibold text-xs mb-4"
 >
 ...
 disabled={processing}
 className="h-14 px-8 bg-[#16a34a] text-white font-bold text-sm font-semibold text-xs hover:bg-[#15803d] transition-all shadow-sm flex items-center gap-3 disabled:opacity-50"
 >
 ...
 disabled={processing}
 className="h-14 px-8 bg-rose-600 text-white font-bold text-sm font-semibold text-xs hover:bg-rose-700 transition-all shadow-sm flex items-center gap-3 disabled:opacity-50"
 >
 ...
 <div className="flex items-center gap-4">
 <div className="h-px flex-1 bg-[#e8f5ee]"/>
 <span className="text-sm font-bold text-white font-semibold text-xs">Arsip Berkas Akademik</span>
 <div className="h-px flex-1 bg-[#e8f5ee]"/>
 </div>
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
 {[
  { label: 'Laporan Utama', path: report.file_path, key: 'file_path', icon: FileText, required: true },
  { label: 'Artikel Ilmiah 1', path: report.article_1_path, key: 'article_1_path', icon: FileText, required: true },
  { label: 'Artikel Ilmiah 2', path: report.article_2_path, key: 'article_2_path', icon: FileText, required: true },
  { label: 'Poster Peta 1', path: report.poster_1_path, key: 'poster_1_path', icon: Image, required: true },
  { label: 'Poster Peta 2', path: report.poster_2_path, key: 'poster_2_path', icon: Image, required: true },
  { label: 'Poster Peta 3', path: report.poster_3_path, key: 'poster_3_path', icon: Image, required: true },
 ].map((item, i) => (
...
"p-6 border flex flex-col gap-4 group/asset transition-all",
 ...
 target="_blank"
 className="mt-2 h-10 w-full bg-gray-100 text-white flex items-center justify-center gap-2 text-sm font-bold font-semibold text-xs hover:bg-[#16a34a] transition-colors"rel="noreferrer"
 >
 ...
 className="bg-gray-100 p-10 text-white shadow-md relative overflow-hidden"
 >
 <div className="absolute inset-0 bg-gray-500/5 -skew-x-12 translate-x-1/2 pointer-events-none"/>
 ...
 className="w-full h-40 bg-white/5 border border-white/10 p-6 text-sm font-bold text-white placeholder:text-white/20 focus:border-emerald-900 focus:ring-0 transition-all"
