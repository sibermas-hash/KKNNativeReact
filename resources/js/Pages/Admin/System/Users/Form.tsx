                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                    ...
                    <section className="bg-white rounded-[2.5rem] border border-slate-100 p-10 lg:p-12 shadow-sm relative group">
                        <div className="flex items-center gap-4 mb-10 border-b border-slate-50 pb-8">
                            <div className="p-3 bg-emerald-50 rounded-2xl border border-slate-200 text-emerald-600">
                                <ShieldCheck size={20} />
                            </div>
                            <div>
                    ...
                    {/* --- STUDENT DATA --- */}
                    {isStudent && (
                        <section className="bg-white rounded-[2.5rem] border border-slate-200 p-10 lg:p-12 shadow-sm relative group">
                            <div className="flex items-center gap-4 mb-10 border-b border-slate-100 pb-8 text-emerald-600">
                                <div className="p-3 bg-emerald-50 rounded-2xl border border-slate-200">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-8 pt-10">
                        <p className="text-[10px] font-bold text-slate-300 uppercase tracking-widest  leading-relaxed text-center sm:text-left">
