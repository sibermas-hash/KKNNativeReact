...
export default function DplGroupsIndex({ groups }: Props) {
 ...
 {groups.length === 0 ? (
 <div className="bg-white rounded-lg border border-slate-100 p-24 text-center group
 ...
 className="group block bg-white rounded-lg border border-slate-100 p-8 hover:border-primary/30 relative overflow-hidden"
 >
