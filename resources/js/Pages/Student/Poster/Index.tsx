      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="rounded-lg border border-emerald-50/60 bg-white p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-emerald-950">Sesuai Lampiran 10 Panduan KKN</p>
            </div>
            <Link
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-emerald-950">
                  Poster Peta Potensi Desa sesuai Lampiran 10 Panduan KKN
                </p>
                <p className="mt-1 text-emerald-950">
                  Unggah poster peta potensi desa dalam format PDF atau gambar (JPG, JPEG, PNG).
                  Ukuran file maksimal {maxSize}. Poster ini memuat peta desa beserta potensi yang
                  ada di lokasi KKN.
                </p>
              </div>
            </div>
        ...
        <div className="rounded-xl border border-emerald-50 bg-emerald-50/30 p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-emerald-950 leading-relaxed">
            Poster Potensi Desa merupakan salah satu <strong>luaran wajib KKN</strong> yang
            berfungsi sebagai media visualisasi hasil observasi dan pemetaan aset desa selama
            pelaksanaan KKN. Poster ini akan menjadi bagian dari laporan akhir kelompok dan
            dipublikasikan oleh LPPM.
          </p>
          <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-lg bg-white p-4 shadow-sm border border-[#f3f4f6]">
              <p className="text-xs font-bold text-emerald-600 font-semibold uppercase text-xs mb-1">
                Branding Desa
              </p>
              <p className="text-sm text-emerald-950 leading-relaxed">
                Membantu desa mempromosikan aset alam, sosial, dan produk UMKM unggulan kepada
                masyarakat luas.
              </p>
            </div>
            <div className="rounded-lg bg-white p-4 shadow-sm border border-[#f3f4f6]">
              ...
              <p className="text-sm text-emerald-950 leading-relaxed">
                Menyederhanakan data pemetaan aset desa (metode ABCD) ke dalam bentuk visual yang
            ...
            <div className="rounded-lg bg-white p-4 shadow-sm border border-[#f3f4f6]">
              ...
              <p className="text-sm text-emerald-950 leading-relaxed">
                Sebagai bukti fisik luaran pengabdian yang akan dipublikasikan di kanal resmi LPPM
                UIN Saizu.
              </p>
            </div>
            <div className="rounded-lg bg-white p-4 shadow-sm border border-[#f3f4f6]">
              ...
              <p className="text-sm text-emerald-950 leading-relaxed">
                Menjadi database potret desa-desa wilayah KKN untuk riset dan pengabdian lanjutan
                kampus.
              </p>
            </div>
          </div>
        ...
        <div className="rounded-xl border border-emerald-50/60 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-emerald-950">
            Pastikan poster yang Anda buat memuat elemen-elemen berikut:
          </p>
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            {[
              {
                label: 'Peta Lokasi Desa',
                desc: 'Peta desa/kelurahan yang menunjukkan batas wilayah dan lokasi potensi',
              },
              {
                label: 'Profil Singkat Desa',
                desc: 'Jumlah penduduk, luas wilayah, struktur pemerintahan dasar',
              },
              {
                label: 'Potensi Alam & SDA',
                desc: 'Pertanian, perkebunan, peternakan, wisata alam, dll',
              },
              {
                label: 'Potensi Sosial & Budaya',
                desc: 'Kesenian, tradisi, organisasi masyarakat, kearifan lokal',
              },
              {
                label: 'Potensi Ekonomi & UMKM',
                desc: 'Produk unggulan, home industry, pasar, komoditas utama',
              },
              {
                label: 'Identitas Kelompok KKN',
                desc: 'Logo UIN Saizu, nama kelompok, periode KKN, nama DPL',
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="flex items-start gap-3 rounded-lg border border-emerald-50/60 bg-emerald-50/30/50 p-3"
              >
          ...
          <div className="mt-4 rounded-lg bg-amber-50 border border-amber-100 p-3">
            <p className="text-xs text-amber-800">
              <strong>Tips:</strong> Gunakan aplikasi seperti Canva, Adobe Illustrator, atau
              Microsoft Publisher untuk membuat desain poster yang menarik. Pastikan resolusi gambar
              minimal 300 DPI untuk kualitas cetak yang baik.
            </p>
          </div>
        </div>
              ...
              <div className="flex items-center gap-4 rounded-lg border border-emerald-50/60 bg-emerald-50/30 p-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-emerald-950 truncate">
                    {kelompok.poster_potensi_desa_name}
                  </p>
        ...
        <form
          ...
          className="rounded-lg border border-emerald-50/60 bg-white p-6"
        >
