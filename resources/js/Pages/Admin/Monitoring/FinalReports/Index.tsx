    ...
    <AppLayout title="Repositori Laporan Akhir">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 space-y-8 py-10 font-sans">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <Deferred
            data="reports"
            fallback={<div className="h-24 bg-gray-50 animate-pulse rounded-2xl" />}
          >
            <StatCard
        ...
        <ContentPanel
          ...
          headerAction={
            <div className="flex items-center gap-3">
              ...
              <button className="h-11 w-11 bg-emerald-950 text-white rounded-xl flex items-center justify-center hover:bg-black transition-all active:scale-95 shadow-lg shadow-emerald-950/10">
                <Filter size={18} />
              </button>
            </div>
          }
          footer={
            <Deferred
              data="reports"
              fallback={<div className="h-4 w-48 bg-gray-50 animate-pulse rounded" />}
            >
          ...
          <Deferred
            ...
            fallback={
              <div className="flex flex-col items-center justify-center py-32 bg-white rounded-3xl">
                ...
                <span className="text-[10px] font-black text-emerald-950/40 uppercase tracking-[0.2em] animate-pulse">
