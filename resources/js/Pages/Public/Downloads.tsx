                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
                        {downloads.map((d, i) => (
                            <motion.div
                                ...
                                className="group relative bg-white p-12 lg:p-16 rounded-[4rem] border border-emerald-100/60 hover:border-emerald-500 hover:shadow-[0_80px_160px_rgba(0,0,0,0.06)] transition-all cursor-pointer"
                            >
                                ...
                                <div className="space-y-12 relative z-10">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[12px] font-bold text-slate-300 uppercase tracking-widest">{d.file_type || 'PDF'}</span>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="text-[12px] font-bold text-emerald-950 uppercase tracking-widest">Dokumen resmi LPPM</p>
                                    </div>
                        ...
                        {/* EMPTY STATE */}
                        {downloads.length === 0 && (
                            <div className="md:col-span-2 py-40 text-center bg-white rounded-[5rem] border border-dashed border-emerald-100/60">
