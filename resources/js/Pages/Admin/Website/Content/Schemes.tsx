...
const colorOptions: Array<{ value: SchemeColor; label: string; dot: string }> = [
 { value: 'emerald', label: 'Hijau (Emerald)', dot: 'bg-gray-500' },
 { value: 'blue', label: 'Biru (Blue)', dot: 'bg-blue-500' },
 { value: 'amber', label: 'Kuning (Amber)', dot: 'bg-amber-500' },
 { value: 'slate', label: 'Abu-abu (Slate)', dot: 'bg-gray-50' },
];
...
export default function SchemeContentPage({ content = { title: '', intro: '', items: [] } }: Props) {
 ...
 <Layers3 size={18} />
 <span className="text-xs font-bold opacity-80">Konten Publik & Operasional</span>
 </div>
 ...
 className="h-14 px-8 bg-[#16a34a] hover:bg-[#15803d] text-white rounded-xl font-bold shadow-sm shadow-none flex items-center gap-3 text-sm transition-all active:scale-95 disabled:opacity-20"
 >
