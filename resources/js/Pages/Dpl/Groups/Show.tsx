        ...
        <AppLayout title={group.name}>
            ...
            <div className="space-y-10 pb-16">
                ...
                <div className="bg-white rounded-lg border border-slate-200 p-10 flex flex-col md:flex-row items-center gap-6 relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-10 text-primary group-hover:scale-110 transition-transform pointer-events-none">
                        <SparklesIcon className="h-48 w-48" />
                    </div>

                    <div className="relative z-10 flex shrink-0">
                        <div className="h-28 w-28rounded-lg bg-primary text-white flex items-center justify-center text-4xl font-extraboldgroup-hover:rotate-6 group-hover:scale-105">
                            {group.code.charAt(0)}
                        </div>
                    </div>
                        ...
                        <section className="bg-white rounded-lg border border-slate-200 p-10 relative overflow-hidden group h-fit">
                            ...
                            {group.posko ? (
                                <div className="space-y-8 relative z-10">
                                    <div className="aspect-[4/3] rounded-[1.75rem] overflow-hidden border border-slate-200 relative group/img">
                                        <img 
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <a 
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="flex items-center justify-center gap-2 w-full py-4 bg-slate-900 text-white rounded-lg text-xs font-semibold  hover:bg-blackactive:scale-95"
                                        >
                                            <MapPinIcon className="h-3 w-3" />
                                            Buka Peta Posko
                                        </a>
                        ...
                        {group.work_programs.length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {group.work_programs.map((wp) => (
                                    <div key={wp.id} className="group/item flex items-center justify-between p-5 rounded-lg bg-slate-50 border border-slate-200 hover:bg-white hover:border-primaryhover:shadow-lg cursor-default">
