...
export const EmptyEnrollmentState = () => {
  return (
    ...
    >
      <div className="h-24 w-24 bg-emerald-50/30 rounded-[2.5rem] mx-auto flex items-center justify-center border border-emerald-100/60 mb-8 text-emerald-400 group-hover:text-emerald-500 group-hover:scale-110 transition-all">
