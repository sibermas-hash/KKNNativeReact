    ...
    <div className="max-w-4xl mx-auto px-4 py-10 space-y-6">
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <Link href="/mahasiswa-v2" className="flex items-center gap-2 text-xs font-bold text-[color:var(--profile-muted)] hover:text-[color:var(--profile-primary)] transition-colors">
