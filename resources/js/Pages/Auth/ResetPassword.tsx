      ...
      <form onSubmit={submit} className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-lime-500 focus:border-lime-500"
        ...
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-base focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
