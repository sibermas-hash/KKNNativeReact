        ...
        <AppLayout title="Preview Nilai">
            ...
            <div className="max-w-6xl mx-auto pb-20 p-6">
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-slate-900  Import Nilai</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-whiterounded-lg p-6 border border-slate-100 overflow-hidden relative">
                            <div className="relative z-10">
                                <p className="text-[10px] font-black text-slate-400 uppercase  mb-4">Ringkasan File</p>
                        ...
                        <div className="bg-slate-900rounded-lg p-6 text-white
                            ...
                            <p className="text-2xl font-black  mb-1">{group.name}</p>
                        ...
                        <Button
                            ...
                            size="lg"
                            className="w-full h-14 rounded-lg font-black 
                        >
