            ...
            <div className="max-w-5xl mx-auto space-y-6 pb-24">
                ...
                */}
                <div className="relative overflow-hidden rounded-lg bg-white from-primary-DEFAULT via-primary-dark to-[#043d23] p-10 md:p-14 border border-primary flex flex-col lg:flex-row lg:items-center justify-between gap-6 group">
                    ...
                    <div className="relative z-10 space-y-5 flex-1">
                        <div className="flex items-center gap-6 mb-2">
                             <Link href="/admin/mahasiswa" className="h-12 w-12 rounded-lg bg-white/10 flex items-center justify-center text-emerald-300 border border-slate-200 hover:bg-white hover:text-primarygroup-hover:scale-105">
                ...
                <div className="bg-white rounded-lg border border-slate-200 overflow-hidden relative group">
                    <div className="absolute top-0 right-0 p-16 text-slate-900 pointer-events-none group-hover:scale-110 transition-transform">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-10 bg-white rounded-lg border border-slate-200 space-y-6 hover:shadow-mdgroup">
                    ...
                    <div className="p-10 bg-white rounded-lg border border-slate-200 space-y-8 hover:shadow-2xl hover:border-primarygroup/module overflow-hidden relative">
