                                            ...
                                            faculties.data.map((f) => (
                                                <tr key={f.id} className="group/row hover:bg-slate-50/20cursor-default">
                                                    <td className="px-6 py-3">
                                                        <div className="px-5 py-2 rounded-lg bg-slate-900 border border-slate-800 text-primary inline-flex font-semibold text-xs  group-hover/row:scale-110 transition-transform">
                                                            {f.code}
                                                        </div>
                                                    </td>
                                                    <td className="px-6 py-3">
                                                    ...
                                                    <td className="px-6 py-3 text-center">
                                                        <div className="inline-flex items-baseline gap-2 px-6 py-3 bg-slate-50 rounded-lg border border-slate-200 group-hover/row:bg-white group-hover/row:border-primary/30 group-hover/row:scale-105 group-hover/row:shadow-xl group-hover/row:shadow-primary/5">
