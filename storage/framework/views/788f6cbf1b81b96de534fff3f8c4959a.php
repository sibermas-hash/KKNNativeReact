    ...
    <div class="border">
        <div class="inner-border">
            ...
            <div class="content">
                ...
                <div class="nim">NIM: <?php echo e($mahasiswa->nim); ?></div>
                <br>
                Telah menyelesaikan pengabdian masyarakat<br>
                <strong><?php echo e($score->kelompok->periode->name ?? 'Kuliah Kerja Nyata'); ?></strong><br>
                di desa <?php echo e($score->kelompok->lokasi->village_name ?? 'Lokasi Terkait'); ?> dengan predikat:<br>
                <span style="font-size: 42px; font-weight: bold; color: #10b981;">"<?php echo e($score->letter_grade); ?>"</span>
            </div>

            <div class="signature">
                Purwokerto, <?php echo e(now()->translatedFormat('d F Y')); ?><br>
            ...
            <div class="legal">
                ...
                ID Sertifikat: <?php echo e(strtoupper(substr(md5($score->id), 0, 8))); ?>
...
<?php /**PATH /var/www/resources/views/pdf/certificate.blade.php ENDPATH**/ ?>