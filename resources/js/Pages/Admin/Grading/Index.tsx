        ...
        return (
            <AppLayout title="Protokol Penilaian">
                <div className="flex h-auto items-center justify-center p-8">
                    <div className="text-center p-14 bg-white rounded-[4rem] border border-slate-200 max-w-2xl relative overflow-hidden group">
        ...
        <AppLayout title="Evaluasi & Capaian Akademik">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 w-full md:w-auto flex-1">
                        ...
                        <div className="relative group/select">
                            ...
                            <select
                                value={selectedGroupId || ''}
                                onChange={(e) => handleGroupChange(e.target.value)}
                                className="bg-white border border-slate-200 rounded-[1.75rem] h-17 pl-14 pr-12 text-xs font-semibold  text-slate-600 outline-none focus:border-primary/50cursor-pointer"
                            >
                                {groups.map(g => (
                                    ...
                                    <tr key={student.id} className="group/row hover:bg-slate-50/20cursor-default">
                                        <td className="px-6 py-8">
                                            <div className="flex items-center gap-6">
                                                <div className="h-14 w-14 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center text-primary font-semibold text-lg group-hover/row:scale-110">
                                        ...
                                        <td className="px-6 py-8 text-right pr-14">
                                            <button
                                                ...
                                                className="inline-flex items-center gap-3 px-6 py-4 bg-slate-900 hover:bg-slate-800 text-white rounded-[1.25rem] font-semibold text-xs disabled:opacity-20 disabled:translate-y-0"
                                            >
            ...
            {selectedStudent && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-slate-950/80">
                    <div className="bg-white rounded-[4rem] w-full max-w-5xl border border-slate-200 overflow-hidden zoom-in-95 group/modal relative">
                        ...
                        <div className="px-12 py-6 border-b border-slate-200 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 bg-slate-50/50 relative overflow-hidden">
                             <div className="absolute top-0 right-0 p-14 text-slate-900 pointer-events-none group-hover/modal:rotate-12 group-hover/modal:scale-125 transition-transform">
                            ...
                            <div className="flex items-center gap-6 px-6 py-8 bg-white rounded-lg border border-slate-200 relative z-10 group/preview transition-transform">
                                ...
                                <button onClick={() => setSelectedStudent(null)} className="absolute -top-4 -right-4 h-12 w-12 bg-white text-slate-400 hover:text-rose-500 rounded-lg flex items-center justify-center border border-slate-200 hover:rotate-90active:scale-90">
                                    <X className="h-6 w-6" />
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="px-6 py-6 bg-slate-50 flex gap-4 border-b border-slate-200">
                            {([
                                ...
                                <button
                                    ...
                                    className={clsx(
                                        "flex-1 py-5 px-6 rounded-lg font-semibold text-xs  flex items-center justify-center gap-4border hover:shadow-md",
                                        activeTab === tab.id 
                        ...
                        <div className="p-14 min-h-[400px] flex items-center justify-center">
                            {activeTab === 'dpl' && (
                                <form onSubmit={submitDpl} className="w-full space-y-6">
                                    ...
                                    <div className="flex justify-end pt-12 border-t border-slate-200 gap-6">
                                        ...
                                        <button type="submit" disabled={dplForm.processing} className="px-12 py-5 bg-slate-900 text-white text-xs font-semibold  rounded-lg hover:bg-slate-800hover:-translate-y-1 flex items-center gap-4 group/submit">
                            ...
                            {activeTab === 'village' && (
                                <form onSubmit={submitVillage} className="w-full space-y-6">
                                    ...
                                    <div className="flex justify-end pt-12 border-t border-slate-200 gap-6 max-w-4xl mx-auto w-full">
                                        <button type="button" onClick={() => setSelectedStudent(null)} className="px-6 py-5 bg-white border border-slate-200 text-slate-400 text-xs font-semibold  rounded-lg hover:bg-slate-50hover:text-slate-600">MENUNDA_SESI</button>
                                        <button type="submit" disabled={villageForm.processing} className="px-12 py-5 bg-slate-900 text-white text-xs font-semibold  rounded-lg hover:bg-slate-800hover:-translate-y-1 flex items-center gap-4 group/submit">
                                            <Save className="h-4.5 w-4.5 text-primary group-hover/submit:rotate-12 transition-transform" />
                                            COMMIT_NILAI_SEKTOR
                                        </button>
                                    </div>
                            ...
                            {activeTab === 'admin' && (
                                <form onSubmit={submitAdmin} className="w-full space-y-6">
                                    ...
                                    <div className="flex justify-end pt-12 border-t border-slate-200 gap-6 max-w-4xl mx-auto w-full">
                                        <button type="button" onClick={() => setSelectedStudent(null)} className="px-6 py-5 bg-white border border-slate-200 text-slate-400 text-xs font-semibold  rounded-lg hover:bg-slate-50hover:text-slate-600">MENUNDA_SESI</button>
                                        <button type="submit" disabled={adminForm.processing} className="px-12 py-5 bg-slate-900 text-white text-xs font-semibold  rounded-lg hover:bg-slate-800hover:-translate-y-1 flex items-center gap-4 group/submit">
                                            <Save className="h-4.5 w-4.5 text-primary group-hover/submit:rotate-12 transition-transform" />
                                            COMMIT_NILAI_ADMIN
                                        </button>
                                    </div>
