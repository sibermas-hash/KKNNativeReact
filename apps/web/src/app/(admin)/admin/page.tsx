...
const ALL_AREAS: AreaDef[] = [
  {
    key: 'operational',
    num: '01',
    title: 'Portal Operasional KKN',
    sub: 'Admin Operasional',
    description: 'Ruang kerja harian admin: pendaftaran, peserta, kelompok, laporan, penilaian, dan siklus operasional KKN.',
  ...
  },
  {
    key: 'blog',
    num: '02',
    title: 'Portal Konten Publik',
    sub: 'Konten & Publikasi',
    description: 'Kelola warta utama, pusat unduhan, profil lembaga, dan skema KKN untuk halaman publik.',
  ...
  },
  {
    key: 'system',
    num: '03',
    title: 'Portal Superadmin Sistem',
    sub: 'Superadmin',
    description: 'Khusus konfigurasi global: pengguna, integrasi, keamanan, audit, sinkronisasi, dan monitoring sistem.',
    href: '/admin/pengguna',
    icon: Settings02Icon,
    color: '#d97706',
