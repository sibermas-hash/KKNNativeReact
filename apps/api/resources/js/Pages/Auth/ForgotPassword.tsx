      ...
      <div className="space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-emerald-800 px-4">
            Masukkan alamat email yang terdaftar pada akun Anda. Kami akan mengirimkan tautan untuk
        ...
        <form onSubmit={submit} className="space-y-5">
          <div>
            <label
              htmlFor="email"
              className="block text-xs font-bold text-emerald-800 uppercase tracking-widest ml-1 mb-2"
            >
              Alamat Email
            </label>
