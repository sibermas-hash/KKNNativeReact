      ...
      >
        ...
        >
          <div className="space-y-1">
            ...
            <p className="text-emerald-900 font-bold uppercase text-sm tracking-widest">
                    ...
                    groups.map((group) => (
                      <tr key={group.id} className="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td className="px-6 py-3">
                          ...
                          <div className="text-sm font-semibold text-emerald-900 uppercase tracking-tight">
                            {group.period_name}
                          </div>
                        </td>
                        <td className="px-6 py-3">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-emerald-900 uppercase leading-none mt-1">
                    Inaktif {'>'} 72 Jam
                  </p>
                </div>
              </div>
              <div className="space-y-3">
                {atRiskStudents.length > 0 ? (
                  atRiskStudents.map((student) => (
                    <div
                      key={student.id}
                      className="flex items-center gap-4 p-4 bg-rose-50/50 rounded-2xl border border-rose-100"
                    >
                  ...
                  <div className="text-center py-6">
                    <p className="text-sm font-bold text-slate-300 uppercase">
                      Semua mahasiswa terpantau aktif
                    </p>
                  </div>
                )}
              </div>
            ...
            >
              ...
              <div className="space-y-3">
                {activityTrend.length > 0 ? (
                  ...
                  <p className="text-sm font-bold text-slate-300 uppercase text-center py-4">
                    Belum ada statistik entri
                  </p>
                )}
              </div>
            </motion.div>
