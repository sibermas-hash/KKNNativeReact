            ...
            <section className="bg-white rounded-xl border border-emerald-50 shadow-sm overflow-hidden">
              <div className="px-8 py-5 border-b border-emerald-50 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-sm font-bold text-emerald-950 uppercase">
                    Bukti Dokumentasi
                  </h2>
                </div>
              ...
              <div className="p-8">
                {imageFiles.length > 0 ? (
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                    {imageFiles.map((file) => (
                      <div
                        key={file.id}
                        className="group relative rounded-2xl overflow-hidden border-2 border-emerald-50/60 hover:border-emerald-300 transition-all shadow-sm aspect-[4/3] bg-emerald-50/30"
                      >
                        <img
                ...
                {otherFiles.length > 0 && (
                  <div className="mt-6 space-y-3">
                    <p className="text-sm font-bold text-emerald-950 uppercase mb-3">
                      Berkas Lainnya
                    </p>
                    {otherFiles.map((file) => (
                      <a
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <FileText
                            size={18}
                            className="text-emerald-950 group-hover:text-emerald-600"
                          />
                        ...
                        <Download
                          size={14}
                          className="text-emerald-100 group-hover:text-emerald-600"
                        />
                      </a>
                    ))}
                  </div>
            ...
            {report.review_notes && (
              <section className="bg-amber-50 rounded-2xl border border-amber-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-sm font-bold text-amber-800 font-semibold uppercase text-xs">
                    Catatan Revisi Sebelumnya
                  </h3>
                </div>
          ...
          <div className="space-y-8">
                ...
                <div className="p-8 space-y-6 relative">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <span className="block text-sm font-bold text-emerald-950 uppercase">
                        ABCD Compliance
                      </span>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {report.ai_analysis.tags.map((tag, idx) => (
                      <span
                        key={idx}
                        className="px-2 py-1 bg-emerald-50 text-emerald-600 text-sm font-bold uppercase rounded-lg border border-emerald-50 transition-colors hover:bg-emerald-100"
                      >
                        #{tag}
                      </span>
                    ))}
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="p-3 bg-emerald-50/30 rounded-xl border border-emerald-50">
                        <span className="block text-sm font-bold text-emerald-300 uppercase mb-1">
                          Lat
                        </span>
                      ...
                      <div className="p-3 bg-emerald-50/30 rounded-xl border border-emerald-50 flex items-center justify-between">
                        ...
                        <span
                          className={clsx(
                            ...
                            report.gps.accuracy <= 50
                              ? 'text-emerald-600'
                              : report.gps.accuracy <= 150
                                ? 'text-amber-600'
                                : 'text-rose-600',
                          )}
                        >
                    ...
                    {report.gps?.distance_to_reference_meters != null && (
                      ...
                      >
                        <div>
                          <span className="block text-sm font-bold uppercase text-emerald-950">
                            Jarak dari {report.gps.reference_label ?? 'Posko'}
                          </span>
                          <span
                            className={clsx(
            ...
            <section className="bg-white rounded-xl border-2 border-[#f3f4f6]0 shadow-lg shadow-emerald-100/50 overflow-hidden">
              <div className="bg-emerald-600 px-6 py-5 flex items-center gap-4 text-white">
                <ShieldCheck size={22} />
                <div>
                  <p className="text-sm font-bold font-semibold uppercase text-xs text-emerald-200">
                    Panel Verifikasi
                  </p>
                ...
                >
                  ...
                  <button
                    ...
                    disabled={
                      ...
                      !revisionForm.data.revision_notes.trim()
                    }
