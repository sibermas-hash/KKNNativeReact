      ...
      <div className="max-w-[1600px] mx-auto space-y-12 pb-24 font-sans px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 pt-12">
          <div className="flex items-center gap-4 text-[#0d9488]">
            ...
            <span className="text-sm font-bold text-xs font-semibold leading-none">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            <div className="space-y-4">
              ...
              <p className="text-sm font-bold text-emerald-800/40 text-xs font-semibold mt-4">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-20">
            <div className="flex items-center gap-6 shrink-0">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm font-bold text-emerald-800/40 text-xs font-semibold mt-1">
            ...
            <div className="flex flex-wrap items-center gap-x-16 gap-y-6">
              <div className="flex flex-col">
                <span className="text-sm font-bold text-emerald-800/20 font-semibold text-xs leading-none mb-3">
                  Ambang Batas Kredit
                </span>
              ...
              <div className="flex flex-col">
                ...
                <span
                  className="text-sm font-bold text-emerald-800/40 max-w-sm truncate"
                    ...
                    <tr key={reg.id} className="hover:bg-gray-50 transition-all duration-300 group">
                      ...
                      <td className="px-6 py-6 text-right">
                        {reg.kelompok ? (
                          ...
                          <span className="text-sm font-bold text-emerald-800/10 text-xs font-semibold leading-none">
                            Belum Terdistribusi
                          </span>
                        )}
                      </td>
  ...
  return (
    <div className="bg-white border border-emerald-50 p-8 rounded-xl shadow-sm hover:shadow-emerald-950/10 transition-all group overflow-hidden relative font-sans">
      ...
      <div className="mt-8 space-y-4 relative z-10 transition-all group-hover:translate-x-1">
        <p className="text-sm font-bold text-emerald-800/40 text-xs font-semibold leading-none">
          {label}
        </p>
        <p
          className={clsx(
