                ...
                <section className="container mx-auto px-6 lg:px-12 py-24">
                        ...
                        {locations.data.length > 0 ? (
                            ...
                            >
                                ...
                                <button 
                                    ...
                                    className="text-xs font-bold text-emerald-600 uppercase tracking-widest border-b-2 border-gray-1000/20 hover:border-emerald-600 transition-all pb-1"
                                >
                    ...
                    {locations.meta && (locations.meta.last_page ?? 1) > 1 && (
                        <div className="mt-24 border-t border-slate-50 pt-16 flex flex-col items-center gap-8">
                             ...
                             <p className="text-xs font-bold text-slate-300 uppercase tracking-widest">Sistem Verifikasi Geospasial v4.0.1</p>
                        </div>
                    )}
                </section>
            </div>
