        ...
        <div className="space-y-8 max-w-3xl">
          <div className="flex items-center gap-6">
            ...
            <div className="space-y-1">
              <h4 className="text-[12px] font-bold uppercase tracking-[0.4em] text-emerald-500">
                Pendaftaran KKN
              </h4>
          ...
          <p className="text-base font-bold text-emerald-950 leading-relaxed uppercase tracking-[0.05em] opacity-80 max-w-xl">
