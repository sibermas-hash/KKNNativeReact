                ...
                <div className="bg-white border-b border-slate-200">
                    <div className="max-w-[1600px] mx-auto px-8 py-12">
                        <div className="flex items-center gap-6">
                            <Link href={route('admin.audit-log.index')} className="h-12 w-12 rounded-xl bg-slate-50 text-gray-400 hover:bg-emerald-600 hover:text-white flex items-center justify-center transition-all active:scale-90 border border-slate-100">
                                <ChevronLeft size={20} />
                            </Link>
                        ...
                        <div className="xl:col-span-8 space-y-8">
                            ...
                            <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
                                <div className="px-8 py-6 border-b border-slate-100 bg-slate-50/30 flex items-center gap-5">
                                    ...
                                    <div>
                                        <h2 className="text-base font-bold text-gray-900">Ringkasan Aktivitas</h2>
                                        <p className="text-sm text-gray-500 mt-0.5">Deskripsi dan waktu kejadian</p>
                                    </div>
                                </div>
                                <div className="p-8 space-y-6">
                                    <p className="text-lg font-bold text-gray-900">{log.description}</p>
                            ...
                            <div className="bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden">
                                <div className="px-8 py-6 border-b border-slate-100 bg-slate-50/30 flex items-center gap-5">
                                    <div className="h-12 w-12 rounded-2xl bg-slate-100 text-gray-600 flex items-center justify-center border border-slate-200 shadow-sm">
                                        <Code2 size={22} />
                                    </div>
                                    <div>
                                        <h2 className="text-base font-bold text-gray-900">Data Properti</h2>
                                        <p className="text-sm text-gray-500 mt-0.5">Detail perubahan data dalam format JSON</p>
                                    </div>
                                </div>
