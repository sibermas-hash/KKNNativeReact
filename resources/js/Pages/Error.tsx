    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
            ...
            >
                ...
                <div className="mb-10 inline-flex h-24 w-24 items-center justify-center rounded-3xl bg-white border border-emerald-100 shadow-xl shadow-emerald-500/10 ring-8 ring-emerald-50/50">
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button 
                        ...
                        className="group flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-6 py-3 text-sm font-bold text-slate-700 hover:bg-slate-50 transition-all duration-200"
                    >
                ...
                <div className="mt-16 flex items-center justify-center gap-2 opacity-50">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-emerald-900">
                        SIM-KKN UIN SAIZU
                    </span>
                    <div className="h-1.5 w-1.5 rounded-full bg-emerald-600" />
                </div>
