        ...
        <AppLayout title="Protokol Siklus KKN">
            ...
            <div className="space-y-12 pb-24">
                ...
                */}
                ...
                {/* Entry Form */}
                {showForm && (
                    <div className="animate-in rounded-lg border border-slate-200 bg-white p-10 relative overflow-hidden group mb-10 mx-2">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pt-10 border-t border-slate-200">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <button 
                                        ...
                                        className="px-12 py-5 bg-primary text-white rounded-lg font-semibold text-xs  hover:bg-primary-darkactive:scale-95 disabled:opacity-50"
                                    >
