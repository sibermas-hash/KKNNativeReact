...
export default function BellDropdown() {
  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className={`relative rounded-xl p-2.5 transition ${
          open
            ...
            : 'text-emerald-950 hover:bg-gray-50/60 hover:text-emerald-800'
        }`}
      >
      ...
      {open && (
        <div className="absolute right-0 top-14 z-[100] w-80 overflow-hidden rounded-xl border border-emerald-50/60 bg-white shadow-lg">
          ...
          <div className="max-h-96 overflow-y-auto">
            {items.length > 0 ? (
              items.map((item) => (
                <div
                  key={item.id}
                  className="border-b border-emerald-50/60 px-4 py-3 hover:bg-gray-50"
                >
