    ...
    public function run(): void
    {
        $types = [
            [
                ...
                'requirements_config' => json_encode(['min_sks' => 100, 'min_gpa' => 0.00]),
                'color' => 'emerald',
                'sort_order' => 1,
            ],
            [
                ...
                'requirements_config' => json_encode(['min_sks' => 85, 'min_gpa' => 3.25]),
                'color' => 'blue',
                'sort_order' => 2,
            ],
            [
                ...
                'requirements_config' => json_encode(['min_sks' => 100, 'min_gpa' => 3.25]),
                'color' => 'purple',
                'sort_order' => 3,
            ],
            [
