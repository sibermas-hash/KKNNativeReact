    ...
    <AppLayout title="Tambah Monitoring">
      ...
      <div className="space-y-8">
        ...
        <section className="rounded-xl border border-emerald-50 bg-white p-8">
          <h1 className="text-2xl font-bold text-emerald-950 uppercase italic mb-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label
                htmlFor="kelompok_id"
                className="block text-sm font-bold text-emerald-950 uppercase mb-1"
              >
            ...
            <div>
              ...
              <textarea
                ...
                required
              />
              {errors.solusi && <p className="mt-1 text-xs text-rose-600">{errors.solusi}</p>}
            </div>
