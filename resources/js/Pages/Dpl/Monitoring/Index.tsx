                        ...
                        {groups.map((group) => (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between text-xs text-emerald-950">
                                    <span>Total: <strong className="text-emerald-950">{group.total_monitoring}</strong> kunjungan</span>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1 space-y-2">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <span className="text-sm font-semibold text-emerald-950">{m.kelompok.nama_kelompok}</span>
                                                    {m.periode && (
