...
const variantStyles: Record<BadgeVariant, string> = {
    default: "bg-emerald-50/50 text-emerald-400 border-emerald-50 italic",
    ...
    primary: "bg-emerald-950 text-white border-emerald-900 shadow-lg shadow-emerald-950/10 italic",
};
