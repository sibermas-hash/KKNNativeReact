                ...
                <div className="relative overflow-hidden rounded-lg bg-white from-primary-DEFAULT via-primary-dark to-[#043d23] p-10 md:p-14 border border-primary flex flex-col lg:flex-row lg:items-center justify-between gap-6 group">
                    ...
                    <div className="relative z-10 space-y-5 flex-1">
                        ...
                        <h1 className="text-4xl md:text-5xl font-semibold text-white  ">
                             Profil <span className="text-emerald-300 text-glow-emerald">Entitas Peserta</span>
                        </h1>
                        ...
                        <div className="bg-white rounded-lg border border-slate-200 p-12 relative group">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                                {registration.documents.length > 0 ? registration.documents.map((doc) => (
                                    <div key={doc.id} className="group/doc relative bg-slate-50 border border-slate-200 rounded-lg p-8 hover:bg-white hover:shadow-2xl hover:border-primary/30cursor-default">
                    ...
                    <div className="space-y-12">
                        ...
                        {isPending && (
                            <div className="bg-white rounded-lg border border-slate-200 p-12 relative overflow-hidden group/nexus">
                                <div className="absolute top-0 right-0 p-10 text-slate-900 pointer-events-none group-hover/nexus:scale-110 transition-transform">
                                    ...
                                    {!showReject ? (
                                        <div className="space-y-5">
                                            ...
                                            <button
                                                ...
                                                className="w-full py-6 bg-white hover:bg-rose-50 text-rose-500 rounded-lg text-xs font-semibold  border-2 border-slate-200 hover:border-rose-200active:scale-95 flex items-center justify-center gap-4
                                            >
