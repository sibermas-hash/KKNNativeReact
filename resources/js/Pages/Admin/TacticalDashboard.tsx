  ...
  return (
    <AppLayout title="Pusat Komando Taktis">
      ...
      <div className="space-y-12 pb-24">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
            <div className="space-y-10 max-w-4xl text-center lg:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 pt-4">
                <button className="flex items-center gap-4 px-6 py-5 bg-white text-emerald-900rounded-lg font-semibold text-xs hover:scale-105 group/btn">
                  Kalibrasi Data
            ...
            <div className="relative z-10 p-1.5 bg-white/10 rounded-lg border border-slate-200 hidden xl:block">
               <div className="bg-slate-900/40 p-12 rounded-[3.3rem] border border-slate-200 flex flex-col items-center gap-8 text-center min-w-[320px]">
        ...
        <div className="p-16 bg-[#043d23] rounded-[4rem] border border-slate-200 text-center md:text-left">
...
function MetricCard({ label, value, icon: Icon, color, unit, trend }: any) {
  ...
  return (
    <div className="bg-white rounded-lg p-10 border border-slate-200 hover:shadow-3xl hover:-translate-y-2group cursor-default">
      <div className="flex items-center gap-5 mb-8">
        <div className={clsx("p-5 rounded-[1.75rem] group-hover:rotate-12", colorMap[color])}>
