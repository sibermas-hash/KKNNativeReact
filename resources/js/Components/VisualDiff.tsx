...
export default function VisualDiff({ oldValues, newValues }: Props) {
  ...
  if (keys.length === 0) {
    return (
      <div className="rounded-lg border border-emerald-50/60 bg-gray-50 p-4 text-sm text-emerald-950">
      ...
      <div className="space-y-2">
        {keys.map((key) => {
          ...
          return (
            ...
            >
              <div className="col-span-4 text-sm font-medium text-emerald-800">
                {formatLabel(key)}
              </div>
