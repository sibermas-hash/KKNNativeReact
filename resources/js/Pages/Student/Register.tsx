...
export default function Register({ periods, student_gender, student_academic }: RegisterProps) {
 ...
 type="button"
 onClick={leaveGroup}
 className="h-16 px-6 rounded-lg bg-slate-50 border border-slate-200 text-rose-500 font-semibold text-xs hover:bg-rose-50 hover:border-rose-100 hover:text-rose-600active:
 >
 ...
 >
 <div className="absolute top-0 right-0 p-8 text-slate-900 pointer-events-none group-hover/card:transition-transform">
