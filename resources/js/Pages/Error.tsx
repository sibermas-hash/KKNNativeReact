    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-emerald-50/30 p-6">
            ...
            >
                ...
                <div className="mb-10 inline-flex h-24 w-24 items-center justify-center rounded-3xl bg-white border border-gray-200 shadow-xl shadow-emerald-500/10 ring-8 ring-emerald-50/50">
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button 
                        ...
                        className="group flex items-center gap-2 rounded-xl border border-gray-200/60 bg-white px-6 py-3 text-sm font-bold text-gray-700 hover:bg-emerald-50/30 transition-all duration-200"
                    >
