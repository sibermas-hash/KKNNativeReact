                ...
                <div className="container relative z-10 mx-auto px-6 lg:px-12">
                    ...
                    <div className="max-w-4xl space-y-12 mb-32">
                        ...
                        >
                            ...
                            <span className="text-xs font-bold text-emerald-950 uppercase tracking-widest">Program & Skema Pengabdian</span>
                        </motion.div>
                        ...
                        {content.items.map((scheme, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="group relative bg-white p-16 lg:p-20 rounded-[4rem] border border-emerald-50/60 hover:border-gray-1000 transition-all hover:shadow-[0_80px_160px_rgba(0,0,0,0.06)] cursor-pointer"
                                >
                                    ...
                                    <div className="space-y-8 relative z-10">
                                        <h4 className="text-4xl lg:text-5xl font-bold text-emerald-950 uppercase tracking-tighter leading-none  group-hover:text-emerald-600 transition-colors">
                                            {scheme.title}
                                        </h4>
                                        <p className="text-emerald-950 text-lg lg:text-xl font-bold leading-relaxed  opacity-80 line-clamp-3">
                                            {scheme.description}
                                        </p>
                                    </div>
