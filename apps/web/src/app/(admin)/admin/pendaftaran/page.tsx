  ...
  return <div className="space-y-6">
    ...
    <div className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button onClick={() => exportFile('xlsx')} className="h-10 rounded-xl bg-teal-600 px-4 text-xs font-black uppercase text-white"><Download size={14} className="inline" /> Export XLSX</button>
        <button onClick={() => exportFile('pdf')} className="h-10 rounded-xl bg-slate-800 px-4 text-xs font-black uppercase text-white"><Download size={14} className="inline" /> Export PDF</button>
