                ...
                <div className="bg-white border-b border-slate-100 px-12 py-12 flex flex-col xl:flex-row xl:items-center justify-between gap-8 sticky top-0 z-20 shadow-sm overflow-hidden relative">
                    ...
                    <div className="space-y-2 relative z-10">
                        <Link 
                            ...
                            className="inline-flex items-center gap-2 text-[10px] text-emerald-400 hover:text-emerald-600 transition-colors uppercase tracking-widest mb-4"
                        >
                    ...
                    {!isFinalized && (
                        <div className="flex items-center gap-4 relative z-10">
                            <button
                                ...
                                disabled={processing}
                                className="h-14 px-8 bg-emerald-600 text-white font-bold text-[10px] uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-lg flex items-center gap-3 disabled:opacity-50"
                            >
                            ...
                            <button
                                ...
                                disabled={processing}
                                className="h-14 px-8 bg-rose-600 text-white font-bold text-[10px] uppercase tracking-widest hover:bg-rose-700 transition-all shadow-lg flex items-center gap-3 disabled:opacity-50"
                            >
                ...
                <div className="px-12 py-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="bg-white border border-slate-200 p-8 shadow-sm group hover:border-slate-900 transition-all">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center gap-4">
                                        <Video className="text-rose-500" />
                                        <span className="text-[10px] font-bold uppercase tracking-widest ">Dokumentasi Video</span>
                                    </div>
                                    <span className="text-[8px] px-2 py-1 bg-emerald-50 text-emerald-600 rounded">5-7 MIN REQ</span>
                                </div>
                                {report.video_link ? (
                                    <a href={report.video_link} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-emerald-50/50 hover:bg-emerald-50 transition-colors border border-slate-100">
                                        <span className="text-[11px] font-bold truncate max-w-[200px]">{report.video_link}</span>
                                        <ExternalLink size={14} className="text-emerald-400" />
                                    </a>
                                ) : (
                                    <div className="p-4 bg-rose-50 text-rose-400 text-[10px] font-bold  uppercase border border-rose-100 flex items-center gap-3">
                            ...
                            <div className="bg-white border border-slate-200 p-8 shadow-sm group hover:border-slate-900 transition-all">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <span className="text-[10px] font-bold uppercase tracking-widest ">Publikasi Berita</span>
                                    </div>
                                    <span className="text-[8px] px-2 py-1 bg-emerald-50 text-emerald-600 rounded">350 WORDS REQ</span>
                                </div>
                                {report.news_link ? (
                                    <a href={report.news_link} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-emerald-50/50 hover:bg-emerald-50 transition-colors border border-slate-100">
                                        <span className="text-[11px] font-bold truncate max-w-[200px]">{report.news_link}</span>
                                        <ExternalLink size={14} className="text-emerald-400" />
                                    </a>
                                ) : (
                                    <div className="p-4 bg-rose-50 text-rose-400 text-[10px] font-bold  uppercase border border-rose-100 flex items-center gap-3">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-[9px] font-bold text-emerald-400 uppercase  tracking-widest">Arsip Berkas Akademik</span>
                                <div className="h-px flex-1 bg-emerald-100" />
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {[
                                    ...
                                    <div key={i} className={clsx(
                                        ...
                                        item.path ? "bg-white border-slate-200 hover:border-slate-900 shadow-sm" : "bg-rose-50/30 border-rose-100 opacity-60"
                                    )}>
                                        ...
                                        {item.path ? (
                                            ...
                                            <div className="mt-2 h-10 w-full border border-rose-200 border-dashed flex items-center justify-center text-rose-400 text-[8px] font-bold uppercase tracking-widest">
                                                NOT_UPLOADED
                                            </div>
                                        )}
                                    </div>
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-8">
                                <div className="flex items-center gap-4 border-b border-white/5 pb-6">
                                    <SearchCheck className="text-emerald-400" size={20} />
                                    <h3 className="text-[12px] font-bold uppercase tracking-widest ">Audit Decision</h3>
                                </div>
                                ...
                                <div className="p-6 bg-white/5 border border-white/5 space-y-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-[10px] font-bold uppercase tracking-widest text-amber-400">Peringatan Audit</span>
                                    </div>
                                    <p className="text-[10px] font-bold text-slate-300/60 leading-relaxed uppercase ">
