                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-1 space-y-6">
                        <section className="bg-white rounded-lg border border-slate-200 p-10 relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-10 text-slate-900 pointer-events-none group-hover:scale-110 transition-transform[2000ms]">
                    ...
                    <div className="lg:col-span-2">
                        {isLeader ? (
                            <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-slate-200 p-12 space-y-6 relative overflow-hidden group">
                                ...
                                <button type="submit" disabled={form.processing} className="w-full md:w-auto px-16 py-6 bg-slate-900 text-whiterounded-lg text-xs font-semibold  hover:bg-blackactive:scale-95 flex items-center justify-center gap-4">
