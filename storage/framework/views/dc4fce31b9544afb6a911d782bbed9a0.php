...
<body>
    <?php $__currentLoopData = $dataGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php 
        $group = $data['group'];
    ...
    <div class="page">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <?php $fill = max(0, 15 - count($students)); ?>
                <?php for($i = 1; $i <= $fill; $i++): ?>
                <tr>
                    <td class="center"><?php echo e(count($students) + $i); ?></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
...
<?php /**PATH /var/www/resources/views/admin/exports/blanko_nilai_bulk.blade.php ENDPATH**/ ?>