  ...
  return (
    <div className="pt-6">
      ...
      <textarea
        ...
        rows={4}
        className="w-full px-8 py-6 rounded-[2rem] border-2 border-[#f3f4f6] bg-gray-50/50 focus:bg-white focus:border-[#f3f4f6]0 focus:ring-8 focus:ring-[#0d9488]/5 transition-all outline-none text-sm font-bold text-emerald-800 placeholder:text-black uppercase tracking-tight"
