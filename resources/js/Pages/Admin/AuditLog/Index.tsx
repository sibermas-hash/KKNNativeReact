 ...
 */}
 ...
 className="px-12 h-18 bg-primary text-white rounded-lg font-semibold text-xs hover:bg-primary-darkactive:shrink-0"
 >
 Terapkan Protokol
 </button>
 </div>
 ...
 <div className={clsx(
 "h-14 w-14 rounded-lg flex items-center justify-center bordergroup-hover/row:group-hover/row:rotate-3",
 ...
 <td className="px-6 py-3">
 <div className={clsx(
 "inline-flex px-5 py-2 rounded-lg text-xs font-semibold border-none group-hover/row:transition-transform",
 cfg.bg, cfg.color
 )}>
 {cfg.label}
 </div>
 ...
 >
 <Eye className="w-6 h-6 stroke-[2.5px] group-hover/btn:transition-transform" />
 </Link>
 </td>
 </tr>
 )
...
function StatCard({ label, value, icon: Icon, color }: any) {
 ...
 return (
 <div className="bg-white p-10 rounded-lg border border-slate-200 flex flex-col justify-between group hover:border-primary/30 hover:-overflow-hidden relative">
 ...
 <div className={clsx("p-5 rounded-lg border-2group-ring-4", colors[color])}>
