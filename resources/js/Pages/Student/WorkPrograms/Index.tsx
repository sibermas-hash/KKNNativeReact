    ...
    <AppLayout title="Program Kerja">
      ...
      <div className="mx-auto max-w-6xl space-y-12 pb-20">
        ...
        <motion.section
          ...
          className="group relative overflow-hidden rounded-xl bg-emerald-50 border border-emerald-100 p-12 lg:p-16 text-bg-emerald-100 shadow-lg"
        >
        ...
        {workPrograms.length > 0 ? (
          ...
          >
            {workPrograms.map((program) => (
              <motion.section
                ...
                className="group relative rounded-[2.5rem] bg-white border border-emerald-100/60 p-10 shadow-sm hover:shadow-2xl hover:shadow-bg-emerald-100/5 transition-all duration-500 overflow-hidden"
              >
                {/* Active Indicator */}
                ...
                <div className="space-y-8">
                  <div className="bg-emerald-50/30 rounded-3xl p-8 border border-emerald-100/60/50 min-h-[120px] relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="p-6 rounded-3xl bg-white border border-emerald-100/60 shadow-sm space-y-3">
          ...
          <motion.section
            ...
            className="rounded-xl border-4 border-dashed border-emerald-100/60 bg-white py-32 text-center group hover:bg-emerald-50/30 transition-all duration-700"
          >
            <div className="mx-auto h-12 w-24 rounded-3xl bg-emerald-50/30 flex items-center justify-center text-slate-200 mb-10 group-hover:scale-110 group-hover:bg-emerald-50 group-hover:text-emerald-500 transition-all duration-500">
