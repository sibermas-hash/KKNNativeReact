...
This document records the repository changes performed to support FreeBSD deployment, API contract, and DB improvements. All future changes must include documentation under /docs.
