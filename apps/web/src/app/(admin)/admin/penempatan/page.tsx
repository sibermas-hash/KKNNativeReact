...
function PtkinDraftPanel({ surfaceClass }: { surfaceClass: string }) {
  const rows = [
    ...
    { kampus: "UIN WALISONGO SEMARANG", kode: "PTKIN-WALISONGO-01", peserta: [
      ...
      ["234110201026", "LIA MUNAWAROH", "P", "Fakultas Ekonomi dan Bisnis Islam", "Ekonomi Syariah"],
      ...
      ["234110302068", "RIJAL MUTAMMAM RASADESPA", "L", "Fakultas Syariah", "Hukum Keluarga (Ahwal Al Syakhshiyah)"],
    ...
    { kampus: "UIN SUNAN GUNUNG DJATI BANDUNG", kode: "PTKIN-SGD-01", peserta: [
      ["234110404109", "ZAHRA FAQIH KAMAL PRASAJA", "P", "Fakultas Tarbiyah dan Ilmu Keguruan", "Tadris Bahasa Inggris"],
      ...
      ["234110101057", "Fadlah Awaliyah", "P", "Fakultas Dakwah", "Bimbingan dan Konseling Islam"],
      ...
      ["234110501083", "MUHAMAD AGUNG KHADAFI", "L", "Fakultas Ushuluddin Adab dan Humaniora", "Ilmu Al-Qur`an dan Tafsir"],
      ["234110404023", "Meisa Nadia", "P", "Fakultas Tarbiyah dan Ilmu Keguruan", "Tadris Bahasa Inggris"],
      ["234110304006", "LANI KHOLIFIANTI", "P", "Fakultas Syariah", "Perbandingan Madzhab"],
