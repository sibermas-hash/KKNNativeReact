...
export default function StudentReportsIndex({ progress, reportTypes }: Props) {
 ...
 <h1 className="text-2xl font-semibold text-emerald-950">Dokumen Kelompok</h1>
 ...
 {progress.length > 0 ? (
 progress.map((item) => (
 <article key={item.type} className="rounded-lg border border-emerald-50/60 bg-white p-6">
 ...
 className="inline-flex items-center rounded-lg border border-emerald-50/60 px-3 py-2 text-sm font-medium text-emerald-800 hover:border-primary hover:text-primary"
 >
 Unduh
 </a>
 )}
 ...
 <div className="rounded-lg border border-emerald-50/60 bg-white px-6 py-6 text-center text-sm text-emerald-950">
 Belum ada dokumen yang dipantau.
 </div>
 )}
 </section>

 <section className="rounded-lg border border-emerald-50/60 bg-white p-6">
 <h2 className="text-lg font-semibold text-emerald-950">Unggah Dokumen</h2>
 <form onSubmit={handleSubmit} className="mt-6 space-y-4">
 <div className="space-y-2">
 <label htmlFor="document-type" className="block text-sm font-medium text-emerald-800">Jenis dokumen</label>
 <select
 id="document-type"
 ...
 <div className="space-y-2">
 <label htmlFor="document-title-input" className="block text-sm font-medium text-emerald-800">Judul dokumen</label>
 <input
 ...
 <div className="space-y-2">
   <label htmlFor="document-file" className="block text-sm font-medium text-emerald-800">Berkas</label>
   <input
     id="document-file"
     type="file"
