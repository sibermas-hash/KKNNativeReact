                    ...
                    <div className="flex flex-wrap items-center gap-6 shrink-0 relative z-10">
                        <div className="px-6 py-6 bg-white/10 rounded-lg border border-slate-200 flex items-center gap-8 min-w-[240px] group/token">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-2xl font-semibold text-white  drop-shadow-sm">{group.token}</span>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:mx-2">
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white p-12 rounded-lg border border-slate-200 relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-14 text-slate-900 pointer-events-none group-hover:scale-110 group-hover:rotate-6 transition-transform">
                        ...
                        <div className="bg-white p-12 rounded-lg border border-slate-200 relative overflow-hidden group">
                            ...
                            {group.posko ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="space-y-10">
                                            <div className="grid grid-cols-2 gap-6">
                                                <div className="p-6 bg-slate-50 border border-slate-200 rounded-lg group/lathover:bg-white hover:shadow-lg">
                                                ...
                                                <div className="p-6 bg-slate-50 border border-slate-200 rounded-lg group/longhover:bg-white hover:shadow-lg">
                                            ...
                                            <a 
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className="inline-flex items-center justify-center gap-4 w-full py-6 bg-slate-900 text-white rounded-lg text-xs font-semibold  hover:bg-slate-800active:scale-95 group/map"
                                            >
                                        ...
                                        <div className="relative aspect-square rounded-lg overflow-hidden border border-slate-200 group/img">
                                            ...
                                            />
                                            <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-slate-950/20 to-transparent opacity-0 group-hover/img:opacity-100 transition-opacity flex flex-col justify-end p-10
                                                <div className="transformy-4 group-hover/img:translate-y-0 transition-transform">
                                ...
                                <div className="py-24 border-3 border-dashed border-slate-200 rounded-lg bg-slate-50/30 flex flex-col items-center justify-center text-center px-6 group/empty">
                                    <div className="p-8 bg-white rounded-lg text-slate-100 group-hover/empty:scale-110 transition-transform">
                            ...
                            <div className="p-12 border-b border-slate-200 flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
                                <div className="flex items-center gap-8">
                                    <div className="p-4 bg-primary text-white rounded-lg relative overflow-hidden group/m">
                                        ...
                                        <div className="absolute inset-0 bg-white/20y-full group-hover/m:translate-y-0 transition-transform" />
                                    </div>
                                    <div>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="bg-white p-12 rounded-lg border border-slate-200 relative overflow-hidden group">
                            <div className="absolute -top-12 -right-12 p-12 text-primary pointer-events-none group-hover:scale-125 transition-transform">
                            ...
                            {group.lecturer ? (
                                <div className="space-y-10 relative z-10">
                                    ...
                                    <div className="p-8 bg-slate-50 border border-slate-200 rounded-lg group/niphover:bg-white hover:shadow-lg">
    ...
    return (
        <div className="group/item space-y-5">
            ...
            <div className="space-y-4 ml-1">
                <p className="text-[17px] font-semibold text-slate-900  group-hover/item:translate-x-1 transition-transform leading-normal drop-shadow-sm">
                    {value}
                </p>
                {status && (
                    <div className={clsx(
