...
<body>
    <div class="container">
            ...
            <?php if($is_valid): ?>
                ...
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo e($certificate_data['name']); ?></div>
                    </div>
                    <div class="info-item">
                        <label class="info-label">Nomor Induk Mahasiswa</label>
                        <div class="info-value"><?php echo e($certificate_data['nim']); ?></div>
                    </div>
                    <div class="info-item">
                        <label class="info-label">Periode KKN</label>
                        <div class="info-value"><?php echo e($certificate_data['period']); ?></div>
                    </div>
                    <div class="info-item">
                        <label class="info-label">Lokasi Pengabdian</label>
                        <div class="info-value"><?php echo e($certificate_data['location']); ?></div>
                    </div>
                    <div class="info-item">
                        <label class="info-label">Predikat Kelulusan</label>
                        <div class="info-value">Predikat: <?php echo e($certificate_data['grade']); ?></div>
                    </div>
                    <div class="info-item">
                        <label class="info-label">Token Verifikasi</label>
                        <div class="token-display"><?php echo e($token); ?></div>
                    </div>
                </div>
            <?php else: ?>
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> SIM-KKN &bull; DIGITAL TRUST SYSTEM</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/resources/views/public/verify-certificate.blade.php ENDPATH**/ ?>