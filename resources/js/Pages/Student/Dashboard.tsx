          ...
          >
            ...
            <div className="flex items-center gap-3 bg-slate-50 p-3 rounded-xl border border-slate-100">
              <div className="text-right">
                <p className="text-sm font-bold text-emerald-900 uppercase leading-none mb-1">
                  Status Keanggotaan
                </p>
              ...
              <div
                className={clsx(
                  ...
                  isApproved ? 'bg-emerald-600 text-white' : 'bg-slate-200 text-emerald-900',
                )}
              >
                ...
                <div key={phase.id} className="relative group">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-emerald-900 uppercase">
                        {phase.desc}
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-xl border border-slate-100 p-5 shadow-sm">
                  <h3 className="text-sm font-bold text-emerald-950 font-semibold uppercase text-xs mb-4 flex items-center gap-2">
                ...
                <div className="bg-slate-50 rounded-xl p-5 border border-slate-100">
                  <h3 className="text-sm font-bold text-emerald-900 font-semibold uppercase text-xs mb-3">
                    Informasi
                  </h3>
...
function StatBox({ icon: Icon, label, value, color = 'emerald' }: DashboardStatProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-100 p-4 shadow-sm flex items-center gap-4">
      ...
      <div>
        <p className="text-sm font-bold text-emerald-900 font-semibold uppercase text-xs leading-none mb-1">
          {label}
        </p>
...
function QuickLink({ href, icon: Icon, label }: DashboardQuickLinkProps) {
  return (
    ...
    >
      ...
      <ArrowRight
        size={12}
        className="ml-auto text-slate-200 group-hover:text-emerald-500 transition-all group-hover:translate-x-1"
      />
    </Link>
  );
}
