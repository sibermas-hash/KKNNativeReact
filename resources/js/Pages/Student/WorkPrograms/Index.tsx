    ...
    <AppLayout title="Program Kerja">
      ...
      <div className="mx-auto max-w-6xl space-y-12 pb-20">
        ...
        <motion.section
          ...
          className="group relative overflow-hidden rounded-[3rem] bg-emerald-50 border border-emerald-100 p-12 lg:p-16 text-bg-emerald-100 shadow-lg"
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-12">
            <div className="space-y-6 max-w-2xl">
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-2xl bg-emerald-500 flex items-center justify-center text-gray-900 shadow-xl shadow-emerald-500/20">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-bold text-gray-400 uppercase tracking-widest leading-relaxed max-w-md opacity-80">
            ...
            {canCreate && (
              <Link
                ...
                className="h-20 px-10 rounded-[2rem] bg-emerald-500 text-gray-900 hover:bg-white transition-all flex items-center justify-center gap-4 group/btn shadow-2xl shadow-emerald-500/20 active:scale-95"
              >
                <Plus
                  size={24}
                  strokeWidth={4}
        ...
        {workPrograms.length > 0 ? (
          ...
          >
            {workPrograms.map((program) => (
              <motion.section
                ...
                className="group relative rounded-[2.5rem] bg-white border border-slate-100 p-10 shadow-sm hover:shadow-2xl hover:shadow-bg-emerald-100/5 transition-all duration-500 overflow-hidden"
              >
                {/* Active Indicator */}
                ...
                <div className="flex items-start justify-between gap-6 mb-10 pb-8 border-b border-slate-50">
                  <div className="space-y-2">
                    ...
                    <h2 className="text-2xl font-black text-gray-900 tracking-tighter uppercase group-hover:text-emerald-600 transition-colors leading-none">
                      {program.title}
                    </h2>
                  </div>
                  <StatusBadge
                    status={program.status}
                    className="rounded-xl px-5 py-2.5 text-[10px] font-black uppercase tracking-widest border-2"
                  />
                </div>
                ...
                <div className="space-y-8">
                  <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100/50 min-h-[120px] relative overflow-hidden">
                    ...
                    <p className="text-[11px] font-bold text-gray-500 leading-relaxed uppercase tracking-tight relative z-10">
                      {program.description ||
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="p-6 rounded-3xl bg-white border border-slate-100 shadow-sm space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-black text-gray-900 uppercase tabular-nums">
                  ...
                  <Link
                    ...
                    className="w-full h-14 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-center justify-between px-8 text-emerald-600 hover:bg-emerald-600 hover:text-white hover:border-emerald-600 transition-all group/link"
                  >
          ...
          >
            ...
            <p className="text-[10px] font-black text-gray-400 mt-4 uppercase tracking-[0.3em] max-w-sm mx-auto leading-relaxed opacity-60">
