...
class RegistrationApprovedNotification extends Notification implements ShouldQueue
{
    ...
    {
        return "✅ *Pendaftaran KKN Disetujui*
...
Buka: '.url('/student/dashboard');
    ...
    {
        return ['type' => 'registration_approved', 'registration_id' => $this->registration->id, 'period_name' => $this->periodName, 'group_name' => $this->groupName, 'message' => "Pendaftaran {$this->periodName} telah disetujui.".($this->groupName ? " Kelompok: {$this->groupName}" : '')];
    }
}
