                    ...
                    {workPrograms.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {workPrograms.map((wp) => (
                                <div 
                                    key={wp.id} 
                                    className="group bg-white rounded-lg border border-slate-200 p-10hover:shadow-2xl hover:border-primary relative overflow-hidden flex flex-col justify-between"
                                >
