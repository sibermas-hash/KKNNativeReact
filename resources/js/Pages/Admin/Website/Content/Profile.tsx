...
export default function ProfileContentPage({ content }: Props) {
 ...
 <span className="text-xs font-bold tracking-[0.25em] opacity-80">Konten Publik & Identitas</span>
 </div>
 ...
 <span className="text-sm font-bold text-black tracking-tight leading-none">UIN SAIZU LPPM</span>
 </div>
 </div>
 </div>
 </div>
 ...
 className="w-full bg-emerald-50/30 border border-emerald-100/60 rounded-lg px-6 py-6 text-sm font-bold text-black focus:bg-white focus:border-emerald-500 outline-none transition-all leading-relaxed"
 ...
 <span className="text-sm font-bold text-emerald-100 tracking-wider text-xs font-semibold">Authorized narrative injection for UIN_SAIZU_DAEMON</span>
 </div>
 </div>
