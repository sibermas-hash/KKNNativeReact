                                    ...
                                    <tr>
                                        <td colSpan={3} className="px-12 py-40 text-center">
                                            <div className="flex flex-col items-center gap-6 opacity-50">
                                                <div className="p-10 bg-slate-50 rounded-lg border border-slate-200 group-hover/ledger:scale-110 transition-transform">
                                    ...
                                    availableDosen.map((dosen) => (
                                        <tr key={dosen.nip} className="group/row hover:bg-slate-50/20cursor-default">
                                            <td className="px-12 py-6">
                                                <div className="flex items-center gap-7">
                                                    <div className="relative">
                                                        <div className="p-4 rounded-lg bg-slate-900 text-primary group-hover/row:scale-110 group-hover/row:shadow-primary/30 group-hover/row:rotate-3h-16 w-16 flex items-center justify-center text-xl font-semibold">
                                                            {getInitials(dosen.name)}
                                                        </div>
                                                        <div className="absolute -bottom-2 -right-2 h-6 w-6 bg-white rounded-lg border-2 border-slate-200 flex items-center justify-center group-hover/row:scale-125 transition-transform">
                                            ...
                                            <td className="px-12 py-6 text-center">
                                                <div className="inline-flex px-6 py-3 rounded-lg bg-slate-50 border border-slate-200 text-slate-500 text-xs font-semibold group-hover/row:bg-white group-hover/row:border-primary/30 group-hover/row:text-primary group-hover/row:shadow-xl group-hover/row:shadow-primary/5">
                     ...
                     <div className="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-6">
                        <div className="space-y-6">
                            ...
                            <p className="text-[14px] text-slate-400 text-sm leading-normal max-w-4xl opacity-75">
                                ...
                                Username primer akan disinkronkan secara absolut mengikuti NIP kandidat. Keamanan transmisi record dijaga melalui <span className="text-primary font-semibold">"End-to-End Encryption"</span> saat proses penulisan ke registry utama. 
