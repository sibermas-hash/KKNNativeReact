    ...
    const [unsubscribe] = persistQueryClient({
      ...
      dehydrateOptions: {
        shouldDehydrateQuery: (query) => {
          ...
          const isAdminDashboard = Array.isArray(key) && key[0] === 'admin' && key[1] === 'dashboard';
          const isPeriodContext = Array.isArray(key) && key[0] === 'period-context';
          // Admin dashboard/period context must be fresh; do not persist stale operational state.
          if (isAdminDashboard || isPeriodContext) return false;
