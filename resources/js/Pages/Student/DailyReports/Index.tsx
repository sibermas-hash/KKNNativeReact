        ...
        <div className="bg-white rounded-[3rem] p-10 border border-emerald-50 shadow-sm space-y-10">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-3xl font-black text-emerald-950 tracking-tight uppercase leading-none mb-1">
                  Logbook Harian
                </h1>
                <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">
                  Manajemen Aktivitas & Pelaporan
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex bg-slate-50 p-1.5 rounded-2xl border border-slate-100">
                <button
                  ...
                  className={clsx(
                    'p-3 rounded-xl transition-all flex items-center gap-2 text-xs font-black uppercase tracking-widest',
                    viewMode === 'timeline'
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="bg-emerald-50/50">
                        ...
                        <th className="p-6 text-[10px] font-black text-emerald-950 uppercase tracking-[0.2em]">
                          Judul Aktivitas
                        </th>
                        <th className="p-6 text-[10px] font-black text-emerald-950 uppercase tracking-[0.2em]">
                          Status
                        ...
                        <React.Fragment key={report.id}>
                          <tr
                            className={clsx(
                              ...
                              expandedId === report.id && 'bg-emerald-50/10',
                            )}
                          >
                            <td className="p-6">
                            ...
                            <td className="p-6 max-w-md">
                              <p className="text-sm font-black text-emerald-950 mb-1 truncate">
                                {report.title}
                              </p>
                                ...
                                <div className="flex items-center gap-2">
                                  <div className="h-2 w-12 bg-slate-100 rounded-full overflow-hidden">
                                    <div
                                      ...
                                      style={{
                                        width: `${report.ai_analysis.abcd_compliance * 10}%`,
                                      }}
                                    />
                                  </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          ...
                          <div className="flex items-center gap-3 p-4 rounded-2xl bg-emerald-50/30 border border-emerald-100/50">
                            ...
                            <div>
                              ...
                              <span className="text-xs font-black text-emerald-950">
                                {report.ai_analysis.quality_score}% Excellent
                              </span>
                            </div>
                          </div>
                        </div>
