...
export default function ProfileShow() {
    ...
    return (
        <AppLayout title="Personal Identity Matrix">
            ...
            >
                {/* --- HEADER ARCHITECTURE --- */}
                <motion.section variants={itemVariants} className="relative rounded-[3rem] bg-slate-900 p-12 overflow-hidden shadow-2xl">
                    <div className="absolute top-0 right-0 w-1/2 h-full bg-emerald-500 opacity-10 skew-x-12 translate-x-32" />
                    <div className="relative flex flex-col md:flex-row items-center gap-10">
                        <div className="relative group cursor-pointer" onClick={() => avatarInputRef.current?.click()}>
                            <div className="h-40 w-40 rounded-full border-4 border-white/20 overflow-hidden bg-slate-800 shadow-2xl relative">
                                {avatarUrl ? (
                                    <img src={avatarUrl} alt={user.name} className="h-full w-full object-cover group-hover:scale-110 transition-transform duration-500" />
                                ) : (
                                    <div className="h-full w-full flex items-center justify-center text-5xl font-black text-slate-700">
                                        {user.name.charAt(0)}
                                    </div>
                                )}
                        ...
                        <div className="flex-1 space-y-4 text-center md:text-left">
                            <div>
                                <h1 className="text-4xl lg:text-5xl font-black text-white tracking-tighter uppercase leading-none">{user.name}</h1>
                                <p className="mt-4 text-emerald-400 font-black uppercase tracking-[0.3em] text-xs">Operator ID: {user.username}</p>
                            </div>
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                                <div className="bg-white/5 border border-white/10 rounded-full px-6 py-2.5 flex items-center gap-3">
                                    ...
                                    <span className="text-sm font-bold text-slate-400 tabular-nums lowercase">{user.email}</span>
                                </div>
                                {student && (
                                    <div className="bg-emerald-500 text-slate-900 rounded-full px-6 py-2.5 flex items-center gap-3 font-black text-[10px] uppercase tracking-widest shadow-xl shadow-emerald-500/20">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                    ...
                    <motion.aside variants={itemVariants} className="xl:col-span-4 space-y-8">
                         ...
                         <div className="bg-white rounded-[2.5rem] border border-slate-100 p-8 shadow-sm space-y-8">
                            <h3 className="text-xs font-black text-slate-400 uppercase tracking-[0.4em] flex items-center gap-4">
                                Clearance <div className="h-px flex-1 bg-slate-50" />
                            </h3>
                            
                            <div className="space-y-6">
                                <div className="flex items-center justify-between p-1 bg-slate-50 rounded-3xl group">
                                    <div className="flex items-center gap-4 pl-5">
                                        <HeartPulse size={20} className={student?.bpjs_complete ? "text-emerald-600" : "text-amber-500"} />
                                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-600">BPJS Integrity</span>
                                    </div>
                                    <div className={clsx(
                                        "px-5 py-2.5 rounded-full text-[9px] font-black uppercase tracking-widest transition-all",
                                        student?.bpjs_complete ? "bg-emerald-500 text-white" : "bg-amber-100 text-amber-700"
                                    )}>
                                ...
                                <div className="flex items-center justify-between p-1 bg-slate-50 rounded-3xl group">
                                    <div className="flex items-center gap-4 pl-5">
                                        <MapPin size={20} className={student?.domicile_verified ? "text-emerald-600" : "text-amber-500"} />
                                        <span className="text-[10px] font-black uppercase tracking-widest text-slate-600">Geo-Verification</span>
                                    </div>
                                    <div className={clsx(
                                        "px-5 py-2.5 rounded-full text-[9px] font-black uppercase tracking-widest transition-all",
                                        student?.domicile_verified ? "bg-emerald-500 text-white" : "bg-amber-100 text-amber-700"
                                    )}>
                            ...
                            {!student?.bpjs_complete && student?.missing_bpjs_fields.length ? (
                                <div className="bg-amber-50 p-6 rounded-2xl border border-amber-100 space-y-3">
                                     <div className="flex items-center gap-3 text-amber-600">
                                         ...
                                         <p className="text-[10px] font-black uppercase tracking-widest">Protocol Required</p>
                                     </div>
                            ...
                            <div className="bg-slate-50 rounded-[2.5rem] p-8 space-y-8">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-white p-5 rounded-2xl border border-white shadow-sm space-y-2">
                                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Global GPA</p>
                                        <p className="text-2xl font-black text-slate-900 tabular-nums">{student.gpa ?? 'N/A'}</p>
                                    </div>
                                    <div className="bg-white p-5 rounded-2xl border border-white shadow-sm space-y-2">
                                        <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Credits Clear</p>
                                        <p className="text-2xl font-black text-slate-900 tabular-nums">{student.sks_completed ?? 0}</p>
                                    </div>
                                </div>
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-1">
                                         <h4 className="text-xs font-black text-slate-900 uppercase tracking-tighter">{student.faculty}</h4>
                                         <p className="text-[11px] font-bold text-slate-500 uppercase tracking-tight italic">{student.program}</p>
                                    </div>
                                </div>
                            </div>
                         )}
                    ...
                    <div className="xl:col-span-8 space-y-10">
                        ...
                        <motion.section variants={itemVariants} className="bg-white rounded-[3rem] border border-slate-100 p-8 lg:p-16 shadow-sm space-y-12">
                             <div className="flex items-center justify-between gap-6 border-b border-slate-50 pb-10">
                                <div className="space-y-2">
                                    <h3 className="text-2xl font-black text-slate-900 tracking-tighter uppercase whitespace-nowrap">Biodata Matrix</h3>
                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest leading-relaxed">Update identitas personal dan koordinat domisili.</p>
                                </div>
                             ...
                             <form onSubmit={handleProfileSubmit} className="space-y-12">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                                    ...
                                    <div className="space-y-4 opacity-70">
                                         <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">System Email</label>
                                         <div className="h-14 bg-slate-100/50 rounded-2xl px-6 flex items-center border border-slate-100">
                                             <span className="text-sm font-bold text-slate-500 italic lowercase tracking-tight">{user.email}</span>
                                    ...
                                    {student && (
                                        <>
                                            <div className="space-y-4">
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Identity (NIK)</label>
                                                <FormInput
                                            ...
                                            <div className="space-y-4">
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Parental Reference</label>
                                                <FormInput
                                            ...
                                            <div className="space-y-4">
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Birth Locality</label>
                                                <FormInput
                                            ...
                                            <div className="space-y-4">
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Timeline Birth</label>
                                                <FormInput
                                                    type="date"
                                            ...
                                            <div className="space-y-4">
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Nexus Phone</label>
                                                <FormInput
                                            ...
                                            <div className="space-y-4">
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Healthcare (BPJS)</label>
                                                <FormInput
                                                    value={profileForm.data.bpjs_number}
                                                    onChange={(e) => profileForm.setData('bpjs_number', e.target.value)}
                                                    error={profileForm.errors.bpjs_number}
                                                    className="border-none bg-slate-50 h-14 rounded-2xl font-bold tabular-nums"
                                                />
                                            </div>
                                            <div className="space-y-4">
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Biological Class</label>
                                                <select
                                                    value={profileForm.data.gender}
                                                    onChange={(e) => profileForm.setData('gender', e.target.value as 'L'|'P')}
                                                    className="w-full h-14 bg-slate-50 border-none rounded-2xl px-6 text-sm font-bold text-slate-900 focus:ring-2 focus:ring-emerald-500 transition-all shadow-inner uppercase tracking-widest"
                                                >
                                                    <option value="">Selection Required</option>
                                                    <option value="L">Laki-laki (Male)</option>
                                                    <option value="P">Perempuan (Female)</option>
                                                </select>
                                                {profileForm.errors.gender && <p className="text-[10px] font-bold text-red-500 uppercase tracking-widest mt-2">{profileForm.errors.gender}</p>}
                                            </div>
                                            <div className="space-y-4">
                                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Apparel Matrix</label>
                                                <select
                                                ...
                                                >
                                                    ...
                                                    {['S', 'M', 'L', 'XL', 'XXL', '3XL'].map(size => <option key={size} value={size}>{size}</option>)}
                                                </select>
                                                {profileForm.errors.shirt_size && <p className="text-[10px] font-bold text-red-500 uppercase tracking-widest mt-2">{profileForm.errors.shirt_size}</p>}
                                            </div>
                                        </>
                                    )}
                                </div>
                                ...
                                <div className="space-y-10">
                                    <div className="space-y-4">
                                         <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Permanent Domicile Address</label>
                                         <FormTextarea
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            {[
                                                ...
                                                <div key={loc.id} className="space-y-3">
                                                    <label className="text-[9px] font-black text-slate-400 uppercase tracking-widest pl-2">{loc.label}</label>
                                                    <FormInput
                                    ...
                                    {student && (
                                        <div className="relative p-8 rounded-[2rem] bg-slate-900 group overflow-hidden shadow-2xl">
                                            <div className="absolute top-0 right-0 h-full w-40 bg-emerald-500 skew-x-12 translate-x-24 opacity-10 group-hover:translate-x-16 transition-transform duration-1000" />
                                            <label className="flex items-start gap-6 relative cursor-pointer group/check">
                                                ...
                                                <div className="space-y-2">
                                                    <p className="text-[11px] font-black text-white uppercase tracking-[0.2em]">Verification Oath</p>
                                                    <p className="text-[11px] font-bold text-slate-400 italic leading-relaxed uppercase tracking-tight">
                                                    ...
                                                    {student.domicile_verified_at && (
                                                        <div className="pt-2 flex items-center gap-2 text-[9px] font-black text-emerald-400 uppercase tracking-widest">
                                                            <UserCheck size={12} /> Verification Timestamp: {new Date(student.domicile_verified_at).toLocaleString('id-ID')}
                                                        </div>
                                                    )}
                                                </div>
                                            </label>
                                            {profileForm.errors.address_verified && (
                                                <p className="mt-4 text-[10px] font-black text-rose-400 uppercase tracking-widest pl-12">{profileForm.errors.address_verified}</p>
                                            )}
                                        </div>
                                    )}
                                </div>
                        ...
                        <motion.section variants={itemVariants} className="bg-white rounded-[3rem] border border-slate-100 p-8 lg:p-16 shadow-sm space-y-12 overflow-hidden relative">
                             ...
                             <div className="border-b border-slate-50 pb-10 flex items-center gap-6 relative">
                                <KeyRound size={28} className="text-slate-900" />
                                <h3 className="text-2xl font-black text-slate-900 tracking-tighter uppercase">Security Protocol</h3>
                             </div>

                             <form onSubmit={handlePasswordSubmit} className="space-y-8 relative">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Current Secret Key</label>
                                        <FormInput
                                            type="password"
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">New Secret Key</label>
                                        <FormInput
                                            type="password"
                                    ...
                                    <div className="space-y-4">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Confirmation Matrix</label>
                                        <FormInput
                                            type="password"
