...
const SETTING_HELPERS: Record<string, string> = {
  ...
  daily_report_geo_radius_meters:
    'Radius maksimal mahasiswa diizinkan melakukan presensi dari titik posko.',
  daily_report_geo_max_accuracy_meters:
    'Semakin kecil nilainya, semakin ketat sistem mendeteksi manipulasi lokasi.',
  registration_lock_ttl_seconds:
    'Durasi waktu kunci kursi saat mahasiswa memproses formulir pendaftaran.',
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12 font-sans text-emerald-950">
            ...
            >
              <div
                className={clsx(
                  ...
                  ai_status?.is_healthy ? 'bg-emerald-500' : 'bg-rose-500',
                )}
              />
              <div className="flex flex-col">
                <span className="text-[10px] font-black text-emerald-800 uppercase tracking-widest leading-none mb-1">
                  AI Service
                </span>
                <span className="text-xs font-black text-emerald-950 uppercase">
                  {ai_status?.is_healthy ? 'Operational' : 'Disconnected'}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
          ...
          <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-24">
            <ContentPanel
              title="Navigasi Menu"
              description="Pilih kategori pengaturan sistem."
              icon={Layers}
              padding={true}
            >
              <nav className="space-y-2">
                ...
                >
                  ...
                  <ChevronRight
                    ...
                    className={clsx(
                      ...
                      activeTab === 'settings' ? 'rotate-90' : 'group-hover:translate-x-1',
                    )}
                  />
                </button>
                ...
                >
                  ...
                  <ChevronRight
                    ...
                    className={clsx(
                      'transition-transform',
                      activeTab === 'ai' ? 'rotate-90' : 'group-hover:translate-x-1',
                    )}
                  />
                </button>
              </nav>
                ...
                {activeTab === 'settings' && (
                  ...
                  >
                    <div className="mt-6 pt-6 border-t border-slate-100 space-y-1">
                      <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-3 ml-2">
                        Quick Access
                      </p>
                        ...
                        <button
                          ...
                          className={clsx(
                            ...
                            activeGroup === group
                              ...
                              : 'text-emerald-950 hover:bg-slate-100',
                          )}
                        >
                ...
                <div className="flex items-start gap-4 p-5 bg-emerald-50/50 rounded-3xl border-2 border-emerald-100/30">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-bold text-emerald-700 uppercase tracking-tight leading-relaxed">
                      Perubahan pada variabel sistem akan langsung berdampak pada alur bisnis aktif.
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {items.map((setting) => {
                              ...
                              return (
                                <div
                                  key={setting.id}
                                  className={clsx('space-y-2.5', isLongText && 'md:col-span-2')}
                                >
                                  <div className="flex items-center justify-between px-1">
                                    <label className="text-[11px] font-black text-emerald-950 uppercase tracking-wider">
                                      {LABEL_OVERRIDE[setting.config_key] || setting.label}
                                    </label>
                                    <code className="text-[9px] font-black text-emerald-400 bg-emerald-950 px-2 py-0.5 rounded-lg border border-emerald-900 tracking-tighter">
                                      {setting.config_key}
                                    </code>
                                  </div>
                                  ...
                                  <div className="relative group">
                                    {isLongText ? (
                                      <textarea
                                        ...
                                        onChange={(event) =>
                                          updateValue(setting.id, event.target.value)
                                        }
                                        rows={5}
                                      ...
                                      <div className="relative">
                                        <input
                                          type={
                                            isSecret && !visiblePasswords[setting.id]
                                              ? 'password'
                                              : 'text'
                                          }
                                          value={getValue(setting.id)}
                                          ...
                                          className={clsx(
                                            ...
                                            getError(setting.id)
                                              ? 'border-rose-100 bg-rose-50 text-rose-900 focus:border-rose-600'
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <MetricCore
                    ...
                    value={ai_status.provider}
                    desc={ai_status.model_text}
                    color="emerald"
                  />
                  <MetricCore
                    icon={Fingerprint}
                    label="Status Sinyal"
                    value={ai_status.is_healthy ? 'SECURED' : 'OFFLINE'}
                    desc={ai_status.is_healthy ? 'API Key Valid & Ready' : 'Memerlukan Konfigurasi'}
                    color={ai_status.is_healthy ? 'emerald' : 'rose'}
                  />
                  <MetricCore
                    icon={History}
                    label="Audit Perbaikan"
                    value={ai_usage?.successful_heals?.toLocaleString('id-ID') || '0'}
                    desc="Total Intervensi Berhasil"
                    color="emerald"
                  />
                  <MetricCore
                    icon={Activity}
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                    ...
                    <div className="space-y-3 text-center md:text-left">
                      ...
                      <p className="text-sm font-bold text-emerald-400/70 leading-relaxed uppercase tracking-tight max-w-xl">
                        Sistem ini menggunakan Google Gemini untuk menganalisis laporan, mendeteksi
                        inkonsistensi data, dan memberikan rekomendasi perbaikan instan kepada
                        mahasiswa.
                      </p>
                    </div>
                  </div>
      ...
      <div className="space-y-6 relative z-10">
        ...
        <div className="space-y-1">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[11px] font-bold text-emerald-800/40 uppercase tracking-tight mt-1">
              {desc}
            </span>
          </div>
        </div>
