    ...
    <div class="border">
        <div class="inner-border">
            <div class="certificate">
                ...
                <div class="number">Nomor: <?php echo e($certificate_number); ?></div>

                <div class="given-to">Diberikan kepada:</div>
                <div class="participant-name"><?php echo e($participant_name); ?></div>
                <div class="nim">NIM: <?php echo e($nim); ?></div>

                <div class="as-participant">
                    Dinyatakan telah mengikuti Workshop Pembekalan KKN dengan tema:<br>
                    <span class="workshop-title">"<?php echo e($workshop_title); ?>"</span><br>
                    Metodologi: <?php echo e($methodology); ?> | Lokasi: <?php echo e($location); ?>

                </div>

                <div style="margin-top: 40px;">
                    Dikeluarkan pada: <?php echo e($issue_date); ?>
...
<?php /**PATH /var/www/resources/views/certificates/workshop.blade.php ENDPATH**/ ?>