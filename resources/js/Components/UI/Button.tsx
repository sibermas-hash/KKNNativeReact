...
const variantStyles: Record<Variant, string> = {
    ...
    clean: 'border border-gray-200/60 bg-white text-xs font-semibold text-gray-900 hover:border-primary-400 hover:text-primary-600 shadow-sm transition-all active:scale-95'
};
