                ...
                */}
                ...
                {showForm && (
                    <div className="bg-white rounded-[3rem] border border-slate-100 overflow-hidden zoom-in-95 relative group mx-2">
                        ...
                        <div className="px-12 py-8 border-b border-slate-50 bg-slate-50/50 flex items-center gap-6 relative z-10">
                        ...
                        <form onSubmit={submit} className="p-12 space-y-10 relative z-10">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                <div className="md:col-span-2 space-y-3 group/field">
                                    <label className="text-[10px] font-black text-slate-400 uppercase  ml-2 italic group-focus-within/field:text-primary transition-colors">Nama_Pembekalan</label>
                                    <input
                                        type="text"
                                        value={data.title}
                                        onChange={e => setData('title', e.target.value)}
                                        className="w-full h-16 bg-slate-50 border border-slate-200 rounded-lg text-sm font-black text-slate-900 focus:bg-white focus:border-primary/50 transition-all outline-none px-8 uppercase italic placeholder:opacity-30"
                                        placeholder="Contoh: Pembekalan KKN Terpadu"
                                    />
                                    {errors.title && <p className="text-rose-500 text-[10px] font-black uppercase  italic ml-1">{errors.title}</p>}
                                </div>

                                <div className="space-y-3 group/field">
                                    <label className="text-[10px] font-black text-slate-400 uppercase  ml-2 italic group-focus-within/field:text-primary transition-colors">Tanggal_Kegiatan</label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-16 pl-16 pr-8 bg-slate-50 border border-slate-200 rounded-lg text-[11px] font-black text-slate-900 focus:bg-white focus:border-primary/50 transition-all outline-none uppercase italic
                                        />
                                    </div>
                                </div>

                                <div className="space-y-3 group/field">
                                    <label className="text-[10px] font-black text-slate-400 uppercase  ml-2 italic group-focus-within/field:text-primary transition-colors">Waktu_Mulai</label>
                                    <div className="relative">
                                    ...
                                    {errors.start_time && <p className="text-rose-500 text-[10px] font-black uppercase  italic ml-1">{errors.start_time}</p>}
                                </div>

                                <div className="space-y-3 group/field">
                                    <label className="text-[10px] font-black text-slate-400 uppercase  ml-2 italic group-focus-within/field:text-primary transition-colors">Waktu_Selesai</label>
                                    <div className="relative">
                                        <Clock3 className="absolute left-6 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-300 group-focus-within/field:text-primary transition-colors z-10" />
                                        <input
                                            type="time"
                                    ...
                                    {errors.end_time && <p className="text-rose-500 text-[10px] font-black uppercase  italic ml-1">{errors.end_time}</p>}
                                </div>

                                <div className="space-y-3 group/field">
                                    <label className="text-[10px] font-black text-slate-400 uppercase  ml-2 italic group-focus-within/field:text-primary transition-colors">Lokasi_Kegiatan</label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-16 pl-16 pr-8 bg-slate-50 border border-slate-200 rounded-lg text-[11px] font-black text-slate-900 focus:bg-white focus:border-primary/50 transition-all outline-none uppercase italic placeholder:opacity-30"
                                ...
                                <div className="space-y-3 group/field">
                                    <label className="text-[10px] font-black text-slate-400 uppercase  ml-2 italic group-focus-within/field:text-primary transition-colors">Kuota_Peserta</label>
                                    <div className="relative">
                                    ...
                                    {errors.max_participants && <p className="text-rose-500 text-[10px] font-black uppercase  italic ml-1">{errors.max_participants}</p>}
                                </div>

                                <div className="md:col-span-2 space-y-3 group/field">
                                    <label className="text-[10px] font-black text-slate-400 uppercase  ml-2 italic group-focus-within/field:text-primary transition-colors">Deskripsi_Pembekalan</label>
                                    <textarea
                                        value={data.description}
                                        onChange={e => setData('description', e.target.value)}
                                        rows={4}
                                        className="w-full p-8 bg-slate-50 border border-slate-200rounded-lg text-sm font-bold text-slate-600 focus:bg-white focus:border-primary/50 transition-all outline-none italic
                                        placeholder="Tuliskan tujuan kegiatan dan pokok bahasan pembekalan..."
                                    />
                                </div>
                            </div>

                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pt-10 border-t border-slate-50 relative z-10">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[10px] font-black uppercase  text-slate-400 italic leading-none mb-1.5">Validasi_Formulir</span>
                                        <span className="text-[8px] font-black text-slate-300 uppercase  italic leading-none">Data siap disimpan</span>
                                    </div>
                                </div>
                                <div className="flex gap-4">
                                    <button
                                        ...
                                        className="px-10 py-5 bg-white border border-slate-200rounded-lg text-[11px] font-black text-slate-400 uppercase  hover:bg-slate-50 transition-all italic"
                                    >
                                        BATAL
                                    </button>
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="px-12 py-5 bg-primary text-whiterounded-lg text-[11px] font-black uppercase  hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 italic"
                                    >
                                        {processing
                                            ? 'MENYIMPAN...'
                ...
                <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:mx-2">
                    {workshops.length > 0 ? workshops.map((workshop) => (
                        <div key={workshop.id} className="bg-white rounded-[3rem] border border-slate-100 group hover:border-primary/30 hover:shadow-2xl hover:-translate-y-2 transition-all overflow-hidden relative flex flex-col">
                            ...
                            <div className="p-12 border-b border-slate-100/50 flex-grow relative overflow-hidden">
                                <div className="absolute -right-6 -top-4 opacity-[0.03] text-slate-900 pointer-events-none group-hover:rotate-12 transition-transform">
                                ...
                                <div className="flex items-start justify-between gap-8 mb-8 relative z-10">
                                    <div>
                                        <div className="flex items-center gap-2 mb-3">
                                            ...
                                            <span className="text-[10px] font-black text-slate-300 uppercase  italic leading-none pt-0.5">Kode: {workshop.id.toString().padStart(4, '0')}</span>
                                        </div>
                                        <h3 className="text-3xl font-black text-slate-900  group-hover:text-primary transition-colors italic uppercase leading-none">{workshop.title}</h3>
                                    </div>
                                    <div className={clsx(
                                        "px-5 py-2 rounded-xl border text-[9px] font-black uppercase  shrink-0 italic transition-all",
                                ...
                                <p className="text-[13px] font-bold text-slate-400 leading-relaxed max-w-xl mb-10 line-clamp-3 italic opacity-80">
                                    {workshop.description}
                                </p>

                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 pt-8 border-t border-slate-50 relative z-10">
                            ...
                            <div className="px-8 py-6 bg-slate-50/50 grid grid-cols-2 gap-4 relative z-10">
                                <button
                                    type="button"
                        ...
                        <div className="col-span-full py-40 bg-white rounded-[4rem] border-2 border-dashed border-slate-100 flex flex-col items-center justify-center gap-10 group">
                            <div className="p-10 bg-slate-50 rounded-full group-hover:scale-110 transition-transform">
                                <Sparkles className="h-20 w-20 text-slate-200" />
                            </div>
                            <p className="text-[12px] font-black text-slate-300 uppercase  italic text-center leading-relaxed">
                                Belum ada pembekalan tersedia<br />
                                <span className="text-primary opacity-60  leading-none mt-2 block lowercase">Siap untuk ditambahkan</span>
                            </p>
                        </div>
                    )}
                </div>
                     ...
                     <div className="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-12">
                        <div className="space-y-6">
                            <div className="flex items-center gap-4">
                                ...
                                <h4 className="text-[11px] font-black text-white uppercase  italic leading-none">STRATEGIC_PREP_PROTOCOL_V3</h4>
                                <p className="text-[10px] text-emerald-400 font-bold  mt-2 italic whitespace-nowrap">STATUS: SECURE_DATA_TRANSMISSION</p>
                            </div>
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-8 bg-slate-900/60">
                        <div className="bg-white rounded-[3.5rem] w-full max-w-xl p-12 border border-slate-100 relative zoom-in-95 overflow-hidden group/modal">
                            ...
                            <div className="relative z-10 space-y-3 mb-12">
                                <h3 className="text-3xl font-black text-slate-900  leading-none italic uppercase">
                                    {modalMode === 'attendance' ? 'Input Presensi' : 'Daftar Peserta'}
                                </h3>
                                <p className="text-[12px] font-black text-primary uppercase  leading-none italic border-l-4 border-primary pl-4">{selectedWorkshop?.title}</p>
                            </div>
                            ...
                            <form onSubmit={submitAttendance} className="space-y-10 relative z-10">
                                <div className="p-8 bg-slate-900 rounded-[2.5rem] border border-slate-800 flex gap-6 group hover:border-primary/30 transition-all">
                                    ...
                                    <p className="text-[12px] font-bold text-slate-400 uppercase  leading-relaxed italic pt-1">
                                ...
                                <div className="space-y-4 max-h-[26rem] overflow-y-auto pr-2 custom-scrollbar">
                                    {participants.length > 0 ? participants.map((participant) => {
                                        ...
                                        return (
                                            <div
                                                key={participant.id}
                                                className="flex items-center justify-between gap-6rounded-lg border border-slate-100 bg-slate-50 px-6 py-5"
                                            >
                                                <div className="min-w-0">
                                                    <p className="text-[12px] font-black uppercase  text-slate-900 italic">
                                                        {participant.name}
                                                    </p>
                                                    <p className="mt-1 text-[10px] font-bold uppercase  text-slate-400 italic">
                                                ...
                                                {modalMode === 'attendance' ? (
                                                    <label className="flex shrink-0 items-center gap-3 rounded-[1.5rem] border border-slate-200 bg-white px-4 py-3 cursor-pointer group/check">
                                                        ...
                                                        />
                                                        <span className="text-[10px] font-black uppercase  text-slate-500 italic group-hover/check:text-primary transition-colors">
                                                            Hadir
                                                        </span>
                                                    </label>
                                                ) : (
                                                    <div className="shrink-0 text-right">
                                                        <p className="text-[9px] font-black uppercase  text-slate-300 italic">Check In</p>
                                                        <p className="mt-1 text-[10px] font-bold uppercase  text-slate-500 italic">
                                        ...
                                        <div className="rounded-[2rem] border border-dashed border-slate-200 bg-slate-50 px-8 py-12 text-center">
                                            <p className="text-[11px] font-black uppercase  text-slate-400 italic">
                                ...
                                <div className="flex gap-6">
                                    <button type="button" onClick={() => setShowAttendanceModal(false)} className="flex-1 py-5 text-[11px] font-black text-slate-400 uppercase  hover:bg-slate-50 border border-slate-100rounded-lg transition-all italic leading-none">TUTUP</button>
                                    {modalMode === 'attendance' && (
                                        <button
                                            type="submit"
                                            disabled={participants.length === 0}
                                            className="flex-[2] py-5 bg-primary text-white text-[11px] font-black uppercase rounded-lg hover:scale-[1.03] active:scale-95 transition-all italic leading-none disabled:opacity-50 disabled:hover:scale-100"
                                        >
                                            SIMPAN PRESENSI
                                        </button>
                                    )}
    ...
    return (
        <div className="flex flex-col gap-2 min-w-0 group/info">
            <div className={clsx("flex items-center gap-2.5", color)}>
                ...
                <span className="text-[10px] font-black uppercase  italic leading-none pt-0.5"> {label}</span>
            </div>
            <span className="text-[11px] font-black text-slate-900 uppercase truncate italic leading-none opacity-80 group-hover/info:opacity-100 transition-all">{value}</span>
        </div>
    );
}
