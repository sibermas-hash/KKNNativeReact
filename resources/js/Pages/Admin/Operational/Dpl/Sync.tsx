...
export default function DplSync({ summary }: Props) {
 ...
 <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 flex items-center gap-10 shadow-sm relative overflow-hidden group/last">
 ...
 <span className="text-xs font-semibold text-gray-700 leading-none mb-2">Sinkronisasi Terakhir</span>
 <span className="text-lg font-semibold text-gray-900 tabular-nums leading-none">
 {formatSyncTime(summary.last_synced_at)}
 </span>
 </div>
 <div className="h-12 w-12 rounded-xl bg-white border border-gray-200 flex items-center justify-center text-[#1a7a4a] relative z-10 shadow-sm">
 ...
 {/* Sinkronisasi Massal */}
 <section className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm flex flex-col group/massal transition-all hover:border-gray-200 font-sans">
 <div className="px-10 py-8 border-b-2 border-gray-200 flex items-center gap-8 bg-gray-50">
 ...
 <h3 className="text-xs font-semibold text-gray-700 leading-none mb-2">Transmisi Kolektif</h3>
 <p className="text-xl font-semibold text-gray-900">Sinkronisasi Massal</p>
 </div>
 </div>

 <div className="p-10 space-y-10 flex-1 flex flex-col">
 <div className="bg-gray-50 border border-gray-200 rounded-xl p-8 space-y-6 flex-1 relative overflow-hidden">
 <div className="absolute top-0 right-0 p-8 opacity-5 -mr-10 -mt-10"><RefreshCw size={150} /></div>
 <p className="text-sm font-bold text-gray-900 leading-relaxed relative z-10">
 ...
 <section className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm flex flex-col group/target transition-all hover:border-gray-200 font-sans">
 <div className="px-10 py-8 border-b-2 border-gray-200 flex items-center gap-8 bg-gray-50">
 ...
 <div className="flex flex-col">
 <h3 className="text-xs font-semibold text-gray-700 leading-none mb-2">Intervensi Spesifik</h3>
 <p className="text-xl font-semibold text-gray-900">Sinkronisasi Target</p>
 </div>
 </div>

 <form onSubmit={submitTargeted} className="p-10 space-y-8 flex-1 flex flex-col">
 <div className="space-y-4 flex-1">
 <label className="text-xs font-semibold text-gray-700 pl-1 leading-none flex items-center gap-3">
 ...
 className="w-full flex-1 px-8 py-8 rounded-xl bg-gray-50 border border-gray-200 text-sm font-bold text-gray-900 focus:bg-white focus:border-[#1a7a4a] outline-none transition-all placeholder:text-gray-400 font-mono scrollbar-hide"
 ...
 <Info size={24} className="text-gray-700 shrink-0 mt-1"strokeWidth={2.5} />
 ...
 <RefreshCw size={40} className="text-gray-700"strokeWidth={2.5} />
 </div>
 <div className="flex flex-col">
 <h3 className="text-2xl font-semibold leading-none mb-1">Kedaulatan Data Master DPL</h3>
 <span className="text-xs font-semibold text-gray-700 opacity-80">Protokol Pemeliharaan Sistem</span>
 </div>
 </div>
...
function SyncMetric({
 ...
 return (
 <div className="bg-white border border-gray-200 p-8 rounded-xl shadow-sm hover:border-gray-200 transition-all group relative overflow-hidden font-sans">
 <div className="flex items-center justify-between relative z-10">
 <div className="h-14 w-14 rounded-xl flex items-center justify-center border border-gray-200 bg-gray-50 text-[#1a7a4a] transition-all duration-500 group-hover:scale-110 shadow-sm">
 <Icon size={24} strokeWidth={2.5} />
 </div>
 <div className="h-8 w-8 bg-gray-50 rounded-full flex items-center justify-center text-gray-500 opacity-0 group-hover:opacity-100 transition-all group-hover:translate-x-1">
 ...
 <p
 className={clsx(
 'font-semibold text-gray-900 er leading-none group-hover:text-gray-700 transition-colors ',
 isText ? 'text-xl' : 'text-3xl',
 )}
 >
 {typeof value === 'number' ? value.toLocaleString('id-ID') : value}
 </p>
 <p className="text-xs font-semibold text-gray-600 pt-3 leading-none">{desc}</p>
 </div>
 </div>
 );
}
