    ...
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      >
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <Link href="/mahasiswa-v2/laporan-harian/buat" className={`px-6 py-3 rounded-2xl font-black uppercase tracking-widest text-xs hover:scale-105 transition-all flex items-center gap-2 ${PRIMARY_CLASS}`}>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          action={<Link href="/mahasiswa-v2/laporan-harian/buat" className={`inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm ${PRIMARY_CLASS}`}>Buat Laporan</Link>}
        />
      ) : (
        <div className="space-y-4">
          {reports.map((report) => (
            <Link
              ...
              href={`/mahasiswa-v2/laporan-harian/${report.id}/edit`}
