                ...
                <div className="relative overflow-hidden rounded-lg bg-white from-primary-DEFAULT via-primary-dark to-[#043d23] p-10 md:p-14 border border-primary flex flex-col lg:flex-row lg:items-center justify-between gap-6 group">
                    ...
                    <div className="relative z-10 space-y-5 flex-1">
                        ...
                        <h1 className="text-4xl md:text-5xl font-semibold text-white  ">
                            Validasi <span className="text-emerald-300 text-glow-emerald">Laporan</span>
                        </h1>
                                    ...
                                    <tr key={r.id} className="group/row hover:bg-slate-50/20cursor-default">
                                        <td className="px-6 py-3">
                                            <div className="flex items-start gap-6 min-w-[350px]">
                                                <div className="h-14 w-14 rounded-lg bg-slate-900 border border-slate-800 text-primary flex items-center justify-center shrink-0 group-hover/row:scale-110 transition-transform
                                        ...
                                        <td className="px-6 py-3">
                                            <div className="flex items-center gap-3 w-fit px-4 py-2 bg-primary/5 rounded-lg border border-primary/10">
                                                ...
                                                <span className="text-[12px] font-semibold text-primary  group-hover/row:scale-105 transition-transform">
                                                    {r.group?.name}
                                                </span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-3 text-center">
                                            <div className="inline-flex items-center justify-center w-16 h-16rounded-lg bg-slate-50 border border-slate-200 group-hover/row:border-primary/30 group-hover/row:bg-whitetransform group-hover/row:shadow-xl group-hover/row:shadow-primary/10 group-hover/row:scale-110">
                                        ...
                                        <td className="px-6 py-8 text-right pr-14">
                                            <div className="flex justify-end">
                                               <StatusBadge status={r.status} className="px-6 py-2.5 rounded-lg text-xs font-semibold  border-none group-hover/row:scale-105 transition-transform" />
                                            </div>
                                        </td>
                                    </tr>
                                )) : (
