...
export default function StudentPoskoEdit({ isLeader, group, posko }: Props) {
 ...
 className="inline-flex items-center rounded-lg border border-emerald-100/60 px-4 py-2 text-sm font-medium text-emerald-700 hover:border-primary hover:text-primary"
 >
 Kembali ke dasbor
 </Link>
 ...
 <span className="inline-flex rounded-full bg-emerald-50/60 px-3 py-1 text-xs font-semibold text-emerald-700">
 ...
 target="_blank"
 rel="noreferrer"
 className="mt-4 inline-flex items-center rounded-lg border border-emerald-100/60 px-4 py-2 text-sm font-medium text-emerald-700 hover:border-primary hover:text-primary"
 >
 Buka Google Maps
 </a>
 )}
 ...
 {posko?.photo_url ? (
 <div className="mt-4 overflow-hidden rounded-lg border border-emerald-100/60">
 <img
 src={posko.photo_url}
 ...
 <div className="md:col-span-2 space-y-2">
   <label htmlFor="posko-photo" className="block text-sm font-medium text-emerald-700">Foto posko</label>
   <input
     id="posko-photo"
     type="file"
 ...
 <Link
 href={route('student.dashboard')}
 className="rounded-lg border border-emerald-100/60 px-4 py-2 text-sm font-medium text-emerald-700 hover:border-primary hover:text-primary"
 >
 Batal
 </Link>
 <button
