          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-[#fafafa]">
              {messages.map((m, i) => (
                ...
                >
                  <div
                    className={`p-2.5 rounded-lg text-xs max-w-[80%] ${m.role === 'user' ? 'bg-[#0d9488] text-white' : 'bg-white border border-emerald-50 text-emerald-950'}`}
                  >
                    {m.text}
                  </div>
                </div>
            ...
            <div className="p-3 border-t border-emerald-50 flex gap-2 bg-white">
              <input
                ...
                className="flex-1 text-sm border border-gray-300 rounded-lg px-3 py-2 focus:border-[#0d9488] focus:ring-1 focus:ring-[#0d9488] outline-none text-emerald-950 placeholder:text-black"
