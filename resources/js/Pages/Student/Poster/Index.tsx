            ...
            <div className="mx-auto max-w-4xl space-y-6">
                ...
                <div className="rounded-lg border border-slate-200 bg-white p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-xl font-semibold text-gray-900">Poster Peta Potensi Desa</h1>
                        ...
                        <Link
                            ...
                            className="inline-flex items-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-slate-50"
                        >
                            <ArrowLeft className="h-4 w-4" /> Kembali
                        </Link>
                    </div>

                    <div className="mt-4 rounded-lg border border-slate-100 bg-slate-50 p-4 text-sm text-gray-600">
                        <div className="flex items-start gap-3">
                            <AlertCircle className="h-5 w-5 text-amber-500 mt-0.5 shrink-0" />
                            <div>
                                <p className="font-medium text-gray-900">Poster Peta Potensi Desa sesuai Lampiran 10 Panduan KKN</p>
                ...
                <div className="rounded-xl border border-emerald-100 bg-emerald-50/30 p-6 shadow-sm">
                    ...
                    <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <div className="rounded-lg bg-white p-4 shadow-sm border border-emerald-50">
                            <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest mb-1">Branding Desa</p>
                            <p className="text-[13px] text-gray-600 leading-relaxed">
                                Membantu desa mempromosikan aset alam, sosial, dan produk UMKM unggulan kepada masyarakat luas.
                            </p>
                        </div>
                        <div className="rounded-lg bg-white p-4 shadow-sm border border-emerald-50">
                            <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest mb-1">Visualisasi Aset</p>
                            <p className="text-[13px] text-gray-600 leading-relaxed">
                                Menyederhanakan data pemetaan aset desa (metode ABCD) ke dalam bentuk visual yang menarik dan mudah dipahami.
                            </p>
                        </div>
                        <div className="rounded-lg bg-white p-4 shadow-sm border border-emerald-50">
                            <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest mb-1">Output Akademik</p>
                            <p className="text-[13px] text-gray-600 leading-relaxed">
                                Sebagai bukti fisik luaran pengabdian yang akan dipublikasikan di kanal resmi LPPM UIN Saizu.
                            </p>
                        </div>
                        <div className="rounded-lg bg-white p-4 shadow-sm border border-emerald-50">
                            <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest mb-1">Arsip LPPM</p>
                            <p className="text-[13px] text-gray-600 leading-relaxed">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-2 text-sm text-gray-500">Pastikan poster yang Anda buat memuat elemen-elemen berikut:</p>
                    <div className="mt-4 grid gap-3 sm:grid-cols-2">
                        {[
                            ...
                            <div key={idx} className="flex items-start gap-3 rounded-lg border border-slate-100 bg-slate-50/50 p-3">
                ...
                {kelompok.poster_potensi_desa_path && (
                    <div className="rounded-lg border border-slate-200 bg-white p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h2 className="font-semibold text-gray-900">Poster Saat Ini</h2>
                                <p className="text-sm text-gray-500">{kelompok.poster_potensi_desa_name}</p>
                            </div>
                        </div>

                        {isImage(kelompok.poster_potensi_desa_name || '') ? (
                            <div className="rounded-lg border border-slate-200 overflow-hidden bg-slate-50 p-4">
                                <img
                            ...
                            <div className="flex items-center gap-4 rounded-lg border border-slate-200 bg-slate-50 p-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-sm font-medium text-gray-900 truncate">{kelompok.poster_potensi_desa_name}</p>
                ...
                <form onSubmit={handleSubmit} className="rounded-lg border border-slate-200 bg-white p-6">
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="font-semibold text-gray-900">Unggah Poster Baru</h2>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/upload">
                                <input
                                    ...
                                    className="block w-full text-sm text-gray-700 file:mr-4 file:rounded-lg file:border-0 file:bg-emerald-50 file:px-4 file:py-2.5 file:text-sm file:font-semibold file:text-emerald-700 hover:file:bg-emerald-100 file:cursor-pointer"
                                />
                            </div>
                            {form.errors.poster && (
                                ...
                                <div className="flex items-center gap-4">
                                    {form.data.poster.type.startsWith('image/') ? (
                                        <>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <p className="text-sm font-medium text-gray-900 truncate">{form.data.poster.name}</p>
                        ...
                        {/* Info */}
                        <div className="rounded-lg border border-slate-100 bg-slate-50 p-4 text-xs text-gray-500 space-y-1">
                    ...
                    <div className="mt-6 flex justify-end gap-3">
                        <Link
                            href={route('student.dashboard')}
                            className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-slate-50"
                        >
                            Batal
                        </Link>
                        <button
