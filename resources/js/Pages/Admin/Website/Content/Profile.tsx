...
export default function ProfileContentPage({ content }: Props) {
 ...
 <span className="text-sm font-bold text-gray-900 font-semibold text-xs leading-none mb-1">Identitas</span>
 <span className="text-sm font-bold text-black leading-none">UIN SAIZU LPPM</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="text-sm font-bold text-black font-semibold text-xs">Official Branding Repository</span>
 </div>
 </div>

 <div className="p-6 space-y-6">
 <div className="space-y-2">
 <label className="text-sm font-bold text-gray-900 font-semibold text-xs block ml-1">Institute_Description_Node</label>
 <textarea
 rows={8}
 value={data.about}
 onChange={(e) => setData('about', e.target.value)}
 className="w-full bg-gray-50 border border-gray-200/60 rounded-lg px-6 py-6 text-sm font-bold text-black focus:bg-white focus:border-[#1a7a4a] outline-none transition-all leading-relaxed"
 ...
 <div className="space-y-2">
 <label className="text-sm font-bold text-gray-900 font-semibold text-xs block ml-1">Vision_Vector</label>
 <textarea
 rows={6}
 value={data.visi}
 ...
 <div className="space-y-2">
 <label className="text-sm font-bold text-gray-900 font-semibold text-xs block ml-1">Mission_Node</label>
 <textarea
 rows={6}
 value={data.misi}
 ...
 <span className="text-sm font-bold text-gray-700 text-xs font-semibold">Authorized narrative injection for UIN_SAIZU_DAEMON</span>
 </div>
 </div>
