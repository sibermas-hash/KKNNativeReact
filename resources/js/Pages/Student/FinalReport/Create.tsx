                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 pb-10 border-b border-slate-200">
                    <div className="flex items-center gap-8">
                        <button 
                            ...
                            className="h-16 w-16 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-slate-300 hover:text-primary hover:border-primary hover:shadow-xlactive:scale-95 group"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {isLeader ? (
                            <section className="bg-white rounded-lg border border-slate-200 p-12 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 p-16 text-primary group-hover:scale-125 transition-transform[2000ms] pointer-events-none">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-12 relative z-10">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="relative group/dropzone overflow-hidden">
                                            ...
                                            >
                                                <div className={clsx(
                                                    "h-20 w-20 rounded-lg border flex items-center justify-center mb-8 transition-transform group-hover/dropzone:scale-110",
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-end gap-6 pt-10 border-t border-slate-200">
                                        ...
                                        >
                                            <Zap className={clsx("h-6 w-6 text-primary", form.processing ? "animate-spin" : "group-hover/btn:rotate-12")} />
                    ...
                    <div className="space-y-12">
                        <section className="bg-primary/5 rounded-lg p-12 border border-primary/10 relative overflow-hidden group">
                            <div className="absolute top-0 right-0 p-10 text-primary group-hover:scale-125 transition-transform pointer-events-none">
                        ...
                        <div className="rounded-[3rem] bg-slate-950 p-12 text-white relative overflow-hidden group border border-slate-900">
