...
export default function DplGroupsIndex({ groups }: Props) {
 ...
 <tr>
 <th className="px-6 py-3 text-left text-xs font-semibold text-gray-900">Kode</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-gray-900">Kelompok</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-gray-900">Lokasi</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-gray-900">Anggota</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-gray-900">Laporan</th>
 <th className="px-6 py-3 text-left text-xs font-semibold text-gray-900">Proker</th>
 ...
 <p className="text-xs text-gray-900">{group.period_name}</p>
 </td>
 <td className="px-6 py-4 text-sm text-gray-900">{group.village_name}</td>
 <td className="px-6 py-4 text-sm text-gray-900">{group.member_count}</td>
 <td className="px-6 py-4 text-sm text-gray-900">{group.daily_report_count}</td>
 <td className="px-6 py-4 text-sm text-gray-900">{group.work_program_count}</td>
 <td className="px-6 py-4">
 ...
 <tr>
 <td colSpan={8} className="px-6 py-6 text-center text-sm text-gray-900">
