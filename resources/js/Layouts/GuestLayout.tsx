...
export default function GuestLayout({
 ...
 <div className="absolute inset-0 bg-whitevia-white/>
 <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-primary/5 rounded-full blur-[120px] -/2 translate-x-1/4" />
 </div>
 ...
 {/* Accent Bottom */}
 <div className="absolute bottom-0 inset-x-0 h-1.5 bg-whitevia-primary/30/>
 </div>
