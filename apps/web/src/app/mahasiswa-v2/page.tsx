...
export default function StudentDashboard(): React.JSX.Element {
  ...
  const dashboardNavItems = [
    { href: '/mahasiswa-v2/laporan-harian', icon: ClipboardList, label: 'Logbook Harian', minPhase: 'execution', lockReason: 'Aktif saat fase pelaksanaan KKN.' },
    { href: '/mahasiswa-v2/program-kerja', icon: Presentation, label: 'Program Kerja', minPhase: 'execution', lockReason: 'Aktif saat fase pelaksanaan KKN.' },
    { href: '/mahasiswa-v2/posko', icon: MapPin, label: 'Detail Posko', minPhase: 'placement', lockReason: 'Aktif setelah fase penempatan.' },
    { href: '/mahasiswa-v2/laporan-akhir', icon: ScrollText, label: 'Laporan Akhir', minPhase: 'grading', lockReason: 'Aktif saat fase pelaporan/penilaian.' },
    { href: '/mahasiswa-v2/sertifikat', icon: Activity, label: 'Sertifikat & Nilai', minPhase: 'grading', lockReason: 'Aktif setelah penilaian dibuka.' },
    { href: '/mahasiswa-v2/evaluasi', icon: Star, label: 'Hasil Evaluasi', minPhase: 'grading', lockReason: 'Aktif setelah penilaian dibuka.' },
    { href: '/mahasiswa-v2/evaluasi-dpl', icon: UserCheck, label: 'Evaluasi DPL', minPhase: 'grading', lockReason: 'Aktif saat fase penilaian.' },
    { href: '/mahasiswa-v2/izin', icon: Plane, label: 'Izin Absensi', minPhase: 'execution', lockReason: 'Aktif saat fase pelaksanaan KKN.' },

    { href: '/mahasiswa-v2/poster', icon: Image, label: 'Poster KKN', minPhase: 'execution', lockReason: 'Aktif saat fase pelaksanaan KKN.' },
  ];
            ...
            {!showKknTools && (
              <div className="bg-slate-900 rounded-xl p-8 text-white relative overflow-hidden shadow-xl">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <Link
                    href={registration ? '/mahasiswa-v2/cek-pendaftaran' : '/mahasiswa-v2/pendaftaran'}
              ...
              {!showKknTools ? (
                <div className="rounded-lg border border-amber-100 bg-amber-50 p-4 text-xs font-semibold text-amber-800">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    <Link href={registration ? '/mahasiswa-v2/cek-pendaftaran' : '/mahasiswa-v2/pendaftaran'} className="rounded-lg bg-amber-600 px-3 py-2 text-[10px] font-black uppercase tracking-wider text-white hover:bg-amber-700">{registration ? 'Cek Status' : 'Daftar KKN'}</Link>
