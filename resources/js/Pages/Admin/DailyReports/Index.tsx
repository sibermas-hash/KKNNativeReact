                ...
                <div className="relative overflow-hidden rounded-lg bg-white from-primary-DEFAULT via-primary-dark to-[#043d23] p-10 md:p-14 border border-primary flex flex-col lg:flex-row lg:items-center justify-between gap-6 group">
                    ...
                    <div className="relative z-10 space-y-5 flex-1">
                        ...
                        <h1 className="text-4xl md:text-5xl font-semibold text-white  ">
                            Arsip <span className="text-emerald-300 text-glow-emerald">Harian</span>
                        </h1>
                    ...
                    <div className="overflow-x-auto relative z-10 custom-scrollbar pr-1">
                        <table className="min-w-full divide-y divide-slate-50">
                            <thead className="bg-slate-50/50">
                                <tr>
                                    <th className="px-6 py-3 text-left text-xs font-semibold  text-slate-400">Tanggal_Kejadian</th>
                                    <th className="px-6 py-3 text-left text-xs font-semibold  text-slate-400">Rincian_Aktivitas</th>
                            ...
                            <tbody className="divide-y divide-slate-50 bg-white">
                                {(reports.data ?? []).length > 0 ? (reports.data ?? []).map((r) => (
                                    <tr key={r.id} className="group/row hover:bg-slate-50/20cursor-default">
                                        ...
                                        <td className="px-6 py-3">
                                            <div className="flex items-center gap-5">
                                                <div className="h-12 w-12 rounded-lg bg-slate-900 border border-slate-800 text-primary flex items-center justify-center font-semibold text-lg group-hover/row:scale-110 transition-transform shrink-0">
