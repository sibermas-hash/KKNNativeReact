...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - System Alert | KKN UIN SAIZU</title>
        ...
        <div class="w-full max-w-xl relative z-10">
            ...
            <div class="rounded-[2.5rem] bg-white border border-slate-200 p-10 shadow-2xl shadow-emerald-900/5 mb-10 relative group">
                <div class="space-y-6 relative">
                    <h1 class="text-3xl font-black text-slate-900 tracking-tighter uppercase leading-none"><?php echo $__env->yieldContent('heading'); ?></h1>
                    <div class="h-1.5 w-16 bg-emerald-500 rounded-full"></div>
                    <p class="text-sm font-bold text-slate-500 leading-relaxed uppercase tracking-wide"><?php echo $__env->yieldContent('message'); ?></p>
                    ...
                    <div class="pt-8 border-t border-slate-100 grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <span class="text-emerald-600 font-black text-sm uppercase"><?php echo $__env->yieldContent('code', 'ERR_001'); ?></span>
                        </div>
                        <div>
                            <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest block mb-1">Waktu Kejadian</span>
                            <span class="text-slate-500 font-bold text-[10px] uppercase"><?php echo e(now()->format('H:i:s T')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /Users/macm4/Documents/Projek/KKN/kknuinsaizu/resources/views/errors/layout.blade.php ENDPATH**/ ?>