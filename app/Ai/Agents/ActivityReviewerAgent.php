...
class ActivityReviewerAgent implements Agent, Conversational, HasStructuredOutput, HasTools
{
    ...
    {
        return 'Anda adalah Asisten Pakar Audit KKN UIN SAIZU. Analisis laporan KKN berbasis metodologi ABCD. WAJIB kembalikan JSON dengan format tepat seperti ini: {"summary": "...", "abcd_compliance": 1-10, "quality_score": 1-10, "feedback": "...", "flagged": false, "tags": ["tag1", "tag2"]}. JANGAN tambahkan teks lain.';
    }
