      ...
      <div className="mx-auto max-w-5xl space-y-10 pb-20">
          ...
          <div className="flex items-center gap-8 relative z-10">
            ...
            <div className="space-y-1">
              <h1 className="text-3xl font-extrabold text-emerald-950">
                Tambah <span className="text-[#0d9488]">Pengguna</span>
              </h1>
              <p className="text-sm font-medium text-emerald-800">
                Registrasi Akun Baru Sistem KKN
              </p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="flex items-center gap-4 mb-10 border-b border-slate-50 pb-8">
              ...
              <div>
                ...
                <p className="text-xs font-normal text-emerald-800 mt-1">
                  Username dan email untuk login.
                </p>
              </div>
            </div>
          ...
          {(isStudent || isDpl || isFacultyAdmin) && (
            <section className="bg-white rounded-xl border border-emerald-50/60 p-10 lg:p-12 shadow-sm relative group">
              <div className="flex items-center gap-4 mb-10 border-b border-slate-50 pb-8">
                <div className="p-3 bg-gray-50 rounded-xl border border-emerald-50/60 text-emerald-950">
                  <HelpCircle size={20} />
                </div>
                <div>
                  <h2 className="text-sm font-bold text-emerald-950 uppercase tracking-wider">
              ...
              <div className="flex items-center gap-4 mb-10 border-b border-emerald-50/60 pb-8 text-[#0d9488]">
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold text-[#0d9488] mt-1">
                    Kewajiban Pengisian Data Pokok
                  </p>
                </div>
              </div>
          ...
          {isDpl && (
            <section className="bg-white rounded-xl border border-emerald-50/60 p-10 lg:p-12 shadow-sm">
              <h2 className="text-sm font-bold text-emerald-950 uppercase tracking-wider mb-10 border-b border-emerald-50 pb-8">
                Validasi Data DPL
              </h2>
              <div className="grid gap-6 md:grid-cols-2">
                <FormInput
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-8 pt-10">
            <div className="flex-1 space-y-2">
              <p className="text-sm font-medium text-emerald-800 leading-relaxed text-center sm:text-left">
                Anda akan membuat akun DPL secara manual. Pastikan data dosen ini{' '}
                <strong>telah lolos verifikasi BKD</strong> dan{' '}
                <strong>tidak berstatus CPNS/Tugas Belajar</strong>.
              </p>
            </div>
        ...
        <footer className="text-center pt-20 border-t border-emerald-50/60">
          <p className="text-sm font-bold text-slate-300 font-semibold text-xs">
            ...
            <span className="text-emerald-600">MAS</span> &bull; UIN SAIFUDDIN ZUHRI &copy; 2026
          </p>
        </footer>
      </div>
    </AppLayout>
