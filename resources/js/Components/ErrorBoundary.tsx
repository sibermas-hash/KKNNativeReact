    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-emerald-50/30 flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-emerald-100/60">
            ...
            <div className="p-8">
              ...
              {isDevelopment() && this.state.error && (
                <div className="mb-6 p-4 bg-emerald-50/30 rounded-lg border border-emerald-100/60">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 bg-white border-2 border-emerald-100/60 hover:border-emerald-100/60 text-emerald-700 font-semibold py-3 rounded-xl transition-all"
                >
                  Kembali ke Beranda
                </button>
              </div>
