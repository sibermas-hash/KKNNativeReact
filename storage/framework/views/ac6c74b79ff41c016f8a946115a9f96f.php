...
<head>
    ...
    <style>
        ...
        .cert-border-inner {
            ...
            padding: 40px;
            box-sizing: border-box;
            background-image: url('<?php echo e($bg_image); ?>');
        ...
        <div class="cert-border-main">
            <div class="cert-border-inner">
                ...
                <div class="main-content">
                    ...
                    <div class="student-info">NIM. <strong><?php echo e($nim); ?></strong></div>
                ...
                <div class="signatures">
                    <table class="sig-table">
                        <tr>
                            <td class="sig-cell">
                                Mengetahui,<br><?php echo e($signer1_title); ?>

                                <div class="sig-name"><?php echo e($signer1_name); ?></div>
                            </td>
                            <td class="sig-qr">
                                <img src="<?php echo e($qr_url); ?>" class="qr-img" alt="QR Code Verification">
                                <div style="font-size: 7px; margin-top: 5px; color: #718096;">VERIFIKASI DIGITAL</div>
                            </td>
                            <td class="sig-cell">
                                Purwokerto, <?php echo e($date); ?><br><?php echo e($signer2_title); ?>

                                <div class="sig-name"><?php echo e($signer2_name); ?></div>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="footer-info">
                    ID Sertifikat: <?php echo e($certificate_no); ?><br>
...
</html><?php /**PATH /Users/macm4/Documents/Projek/KKN/kknuinsaizu/resources/views/reports/certificate.blade.php ENDPATH**/ ?>