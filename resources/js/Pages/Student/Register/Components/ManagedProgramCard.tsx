...
export const ManagedProgramCard = ({ program }: { program: PeriodOption }) => {
  return (
    <article className="p-10 rounded-[3.5rem] bg-white border border-emerald-50/60 hover:border-[#f3f4f6]0 hover:shadow-2xl transition-all duration-700 group relative overflow-hidden">
      ...
      <h3 className="text-2xl font-bold text-emerald-950 tracking-tighter uppercase mb-8 group-hover:text-emerald-800 transition-colors">
        {program.nama}
      </h3>

      <div className="grid grid-cols-2 gap-4 mb-10">
        <div className="p-4 bg-emerald-50/30 rounded-2xl border border-emerald-50/60/50">
      ...
      {program.guide && (
        <div className="p-6 bg-emerald-50/20 rounded-xl border border-emerald-50 shadow-inner">
          <p className="text-sm font-bold text-emerald-800 uppercase tracking-wider text-xs font-semibold mb-4 flex items-center gap-2">
