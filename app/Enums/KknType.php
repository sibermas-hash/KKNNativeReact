...
enum KknType: string
{
    ...
    public function label(): string
    {
        return match($this) {
            ...
            self::RESPONSIF => __('KKN Responsif'),
    ...
    public function description(): string
    {
        return match($this) {
            ...
            self::RESPONSIF => __('KKN tanggap isu sosial atau kebencanaan yang bersifat mendesak.'),
    ...
    public function registrationMode(): string
    {
        return match($this) {
            ...
            self::TEMATIK, self::KAMPUNG_ZAKAT, self::DESA_KATANA => 'proposal_based', // Berbasis program dosen
    ...
    public function placementMode(): string
    {
        return match($this) {
            ...
            self::TEMATIK, self::KAMPUNG_ZAKAT, self::DESA_KATANA => 'proposal_defined', // Mengikuti proposal
