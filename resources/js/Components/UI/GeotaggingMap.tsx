...
export default function GeotaggingMap({
  ...
  return (
    ...
    >
      ...
      {/* Tactical Overlay */}
      <div className="absolute top-4 right-4 z-[1000] px-4 py-2 bg-emerald-600/90 backdrop-blur-md border border-emerald-500/30 text-white text-[9px] font-bold uppercase tracking-[0.2em] shadow-2xl pointer-events-none group-hover/map:opacity-0 transition-opacity">
