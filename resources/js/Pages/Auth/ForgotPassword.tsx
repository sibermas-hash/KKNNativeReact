...
export default function ForgotPassword({ status }: Props) {
 ...
 Lupa kata sandi Anda? Masukkan alamat email yang terdaftar dan kami akan mengirimkan
 tautan untuk menyetel ulang kata sandi Anda.
 </div>
 ...
 >
 {processing ? 'Mengirim...' : 'Kirim Tautan Atur Ulang Kata Sandi'}
 </button>
