...
export default function StudentReportsIndex({ progress, reportTypes }: Props) {
 ...
 <h1 className="text-2xl font-semibold text-gray-900">Dokumen Kelompok</h1>
 ...
 <p className="mt-1 text-xs text-gray-500">{item.report.file_name}</p>
 )}
 </div>
 ...
 className="inline-flex items-center rounded-lg border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 hover:border-primary hover:text-primary"
 >
 Unduh
 </a>
 )}
 ...
 <div className="rounded-lg border border-slate-200 bg-white px-6 py-12 text-center text-sm text-gray-500">
 ...
 <h2 className="text-lg font-semibold text-gray-900">Unggah Dokumen</h2>
