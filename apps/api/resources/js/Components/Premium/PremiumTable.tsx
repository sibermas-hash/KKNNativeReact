            ...
            {headers.map((header, index) => (
              <th
                ...
                className={clsx(
                  ...
                  header === 'Aksi' || header === 'Tindakan' || header === 'Opsi'
                    ? 'text-right'
                    : 'text-left',
            ...
            <tr>
              <td colSpan={headers.length} className="px-6 py-24 text-center">
                <div className="flex flex-col items-center justify-center gap-4">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-[0.25em] text-emerald-950/20 font-display">
                    Data Kosong
                  </span>
                  <p className="text-xs font-bold text-emerald-800/40 uppercase tracking-tight max-w-xs leading-relaxed">
                    {emptyText}
                  </p>
                </div>
              </td>
